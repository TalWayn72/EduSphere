...
(async () => {
  ...
  await page.route('**/graphql', async (route) => {
    ...
    const courseB = {
      ...
      slug: 'adv-db',
      description:
        'Deep dive into distributed databases and query optimization',
      isPublished: true,
      estimatedHours: 15,
      thumbnailUrl: null,
      instructorId: 'dev-user-id',
  ...
  await page.screenshot({
    path: `${SCREENSHOTS}/bug103-delete-before.png`,
    fullPage: false,
  });
  ...
  await page.waitForURL((url) => new URL(url).pathname === '/courses', {
    timeout: 10000,
  });
  await page.waitForTimeout(2000);
  ...
  await page.screenshot({
    path: `${SCREENSHOTS}/bug103-delete-after.png`,
    fullPage: false,
  });
