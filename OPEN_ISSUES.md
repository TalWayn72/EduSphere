...
**בדיקות:** Security: **948 tests** (36 spec files) | AGE Graph: 52 | NATS Schema: 56 | LangGraph: **154** | Mobile: **256 tests** (21 files) | Web: **3,860** (300 files) | Backend subgraphs: **2,500+** (core 719 + content 1096 + annotation 144 + collab 161 + agent 677 + knowledge 509) | Gateway contract: **142** | i18n: **304** | Pentest visual-anchoring: **36** | סה"כ: **~6,100 tests** | Security ESLint: ✅ | CodeQL: ✅ | Playwright E2E: ✅ | TypeScript: **0 errors** (26/26 packages)
