...
**בדיקות:** Security: **928 tests** (36 spec files) | AGE Graph: 52 | NATS Schema: 56 | LangGraph: **154** | Mobile offline: **31 unit** + 34 static | Web: **3,750** (287 files) | Backend subgraphs: **2,429+** (core 640 + content 1096 + annotation 144 + collab 161 + agent 677 + knowledge 509) | Gateway contract: **88** | i18n: **304** | Pentest visual-anchoring: **36** | סה"כ: **~5,780 tests** | Security ESLint: ✅ | CodeQL: ✅ | Playwright E2E: ✅ | TypeScript: **0 errors** (26/26 packages)
