...
"""
User UI and localization preferences stored in users.preferences JSONB.
...
type Mutation {
  ...
  """
  Update the current user's preferences (locale, theme, notification settings).
...
"""
Input for the updateUserPreferences mutation.
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#  ContentTranslation (i18n Phase B)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

"""
Lifecycle status of an on-demand content translation.
...
"""
An AI-generated translation of a ContentItem into a specific target locale.
Stored in the content_translations table; fetched via contentTranslation query.
Cache-first: a COMPLETED translation is returned immediately without re-triggering.
"""
...
type Query {
  ...
  """
  Fetch an existing translation for a content item in the specified locale.
...
type Mutation {
  ...
  """
  Request an AI-generated translation for a content item.
  Cache-first: if a COMPLETED translation already exists for this (contentItemId, locale) pair,
  it is returned immediately without re-triggering.
  If no translation exists (or status is FAILED), a NATS event is published to the
  translation worker and a ContentTranslation record with status PENDING is returned.
  """
...
## Section 31 — Polished Transcripts (Smart Transcript Polishing, 2026-04-17)
