...
_Document owner: DPO (to be appointed) / CISO (interim) | Stored at: `docs/compliance/DPIA.md`_
_Related documents: `ROPA.md`, `BREACH-NOTIFICATION-PROCEDURE.md`, `EU-AI-ACT-TECHNICAL-DOCUMENTATION.md`_
