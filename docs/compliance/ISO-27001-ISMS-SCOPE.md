...
_This document satisfies ISO/IEC 27001:2022 Clause 4.3 requirements for documenting the scope of the ISMS. Version controlled in git; change history available via `git log docs/compliance/ISO-27001-ISMS-SCOPE.md`._
