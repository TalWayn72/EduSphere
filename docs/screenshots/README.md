# Screenshots — EduSphere

All project screenshots are stored here. They are captured during development sessions as visual verification evidence.

## Naming Convention

`scan-<feature>[-<variant>].png` — Playwright or manual browser scans
`step<N>-<description>.png` — Step-by-step flow verification screenshots
...
- `step1-dashboard-loaded.png`, `step2-user-menu-open.png`, `step3-after-logout-login-page.png`
...
- `scan-library.png`
- `scan-marketplace.png`
- `scan-my-badges.png`, `scan-my-badges-new.png`
- `scan-settings-fixed.png`, `scan-results-settings-fixed.png`
- `scan-results-page-fixed.png`
- `scan-accessibility.png`
...
**New screenshots must NEVER be saved to the project root.** Always save to this folder.
See `docs/reference/DOCUMENT_NAMING_STANDARDS.md` for full storage rules.
