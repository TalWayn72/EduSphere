...
_This document fulfills G-18 (Incident Response Procedure) and supports GDPR Art. 33–34
compliance. See also: `docs/security/SUBPROCESSORS.md`, `docs/security/PROCESSING_ACTIVITIES.md`._
