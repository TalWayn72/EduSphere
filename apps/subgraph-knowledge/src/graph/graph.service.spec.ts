...
describe('GraphService', () => {
  ...
  describe('query delegation', () => {
    it('findConceptById delegates to queries', async () => {
      ...
      expect(mockQueries.findConceptById).toHaveBeenCalledWith(
        'concept-1',
        T,
        U,
        R
    ...
    it('findConceptByName delegates to queries', async () => {
      ...
      expect(mockQueries.findConceptByName).toHaveBeenCalledWith(
        'Free Will',
        T,
        U,
        R
    ...
    it('getLearningPath delegates to queries', async () => {
      ...
      expect(mockQueries.getLearningPath).toHaveBeenCalledWith(
        'A',
        'B',
        T,
        U,
    ...
    it('getPrerequisiteChain delegates to queries', async () => {
      ...
      expect(mockQueries.getPrerequisiteChain).toHaveBeenCalledWith(
        'Calculus',
        T,
        U,
        R
  ...
  describe('mutation delegation', () => {
    ...
    it('deleteConcept delegates to mutations', async () => {
      ...
      expect(mockMutations.deleteConcept).toHaveBeenCalledWith(
        'concept-1',
        T,
        U,
        R
