/**
 * KMeansAlgorithmService — K-means++ clustering algorithm (pure math).
 *
 * Contains cosine distance, mean vector, k-means++ initialization,
 * and the core k-means iteration loop. No I/O or database access.
 */
...
@Injectable()
export class KMeansAlgorithmService {
