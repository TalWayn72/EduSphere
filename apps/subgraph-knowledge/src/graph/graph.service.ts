...
export class GraphService {
  ...
  createConcept(
    ...
    return this.mutations.createConcept(
      name,
      definition,
      sourceIds,
      tenantId,
  ...
  findRelatedConcepts(
    ...
    return this.queries.findRelatedConcepts(
      conceptId,
      depth,
      limit,
      tenantId,
  ...
  generateEmbedding(
    ...
    return this.mutations.generateEmbedding(
      text,
      entityType,
      entityId,
      tenantId,
  ...
  createSource(
    ...
    return this.mutations.createSource(
      title,
      type,
      url,
      tenantId,
  ...
  findTopicClustersByCourse(
    ...
    return this.queries.findTopicClustersByCourse(
      courseId,
      tenantId,
      userId,
      role
  ...
  createTopicCluster(
    ...
    return this.mutations.createTopicCluster(
      name,
      description,
      tenantId,
      userId,
  ...
  getRelatedConceptsByName(
    ...
    return this.queries.getRelatedConceptsByName(
      conceptName,
      depth,
      tenantId,
      userId,
  ...
  getPrerequisiteChain(
    ...
    return this.queries.getPrerequisiteChain(
      conceptName,
      tenantId,
      userId,
      role
