...
export class GraphService {
  ...
  createConcept(
    ...
    return this.concept.createConcept(name, definition, sourceIds, tenantId, userId, role);
  }
  ...
  findRelatedConcepts(
    ...
    return this.concept.findRelatedConcepts(conceptId, depth, limit, tenantId, userId, role);
  }
  ...
  generateEmbedding(
    ...
    return this.search.generateEmbedding(text, entityType, entityId, tenantId, userId, role);
  }
  ...
  createSource(
    ...
    return this.personTerm.createSource(title, type, url, tenantId, userId, role);
  }
  ...
  findTopicClustersByCourse(courseId: string, tenantId: string, userId: string, role: string) {
    return this.personTerm.findTopicClustersByCourse(courseId, tenantId, userId, role);
  }
  ...
  createTopicCluster(
    ...
    return this.personTerm.createTopicCluster(name, description, tenantId, userId, role);
  }
  ...
  getRelatedConceptsByName(
    conceptName: string, depth: number,
    tenantId: string, userId: string, role: string,
  ) {
    return this.personTerm.getRelatedConceptsByName(conceptName, depth, tenantId, userId, role);
  }

  getPrerequisiteChain(conceptName: string, tenantId: string, userId: string, role: string) {
    return this.personTerm.getPrerequisiteChain(conceptName, tenantId, userId, role);
  }
}
