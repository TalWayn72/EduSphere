...
export const HTTP_REQUESTS_TOTAL = new Counter({
  name: 'edusphere_content_http_requests_total',
...
export const GRAPHQL_QUERY_DURATION = new Histogram({
  name: 'edusphere_content_graphql_query_duration_seconds',
