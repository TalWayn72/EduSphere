...
import { BreakoutService, type CreateBreakoutRoomInput } from './breakout.service';
...
export class LiveSessionExtensionsResolver {
  ...
  async breakoutRooms(
    ...
    return this.breakoutService.listRooms(sessionId, this.tenantId(ctx), this.userId(ctx));
  }
  ...
  async sessionPolls(
    ...
    return this.pollService.listPolls(sessionId, this.tenantId(ctx), this.userId(ctx));
  }
  ...
  async pollResults(
    ...
    return this.pollService.getPollResults(pollId, this.tenantId(ctx), this.userId(ctx));
  }
  ...
  async activatePoll(
    ...
    return this.pollService.activatePoll(pollId, this.tenantId(ctx), this.userId(ctx));
  }
  ...
  async closePoll(
    ...
    return this.pollService.closePoll(pollId, this.tenantId(ctx), this.userId(ctx));
  }
