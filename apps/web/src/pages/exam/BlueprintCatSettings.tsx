      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Label htmlFor="cat-toggle" className="text-sm">
              Enable CAT
            </Label>
            <Switch
              id="cat-toggle"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Minimum questions before stopping
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Maximum questions administered
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
