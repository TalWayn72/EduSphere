...
export const SkeletonLine = React.memo(function SkeletonLine({ className = '' }: { className?: string }) {
  return (
    <div
...
export const ErrorBanner = React.memo(function ErrorBanner({ message }: { message: string }) {
  return (
