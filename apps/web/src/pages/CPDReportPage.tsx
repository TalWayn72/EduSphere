...
export function CPDReportPage() {
  ...
  const [, exportReport] = useMutation<{ exportCpdReport: string }>(
    EXPORT_CPD_REPORT_MUTATION
  );
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Continuing Professional Development credits earned
            </p>
          </div>
        </div>
                      ...
                      {report.entries.map((entry) => (
                        <tr key={entry.id} className="border-t">
                          ...
                          <td className="p-2 font-mono">
                            {entry.earnedHours.toFixed(2)}
                          </td>
                          <td className="p-2">
                            {entry.completionDate.split('T')[0]}
                          </td>
                        </tr>
                      ))}
                    </tbody>
