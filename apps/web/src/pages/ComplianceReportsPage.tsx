...
export function ComplianceReportsPage() {
  ...
  const [, updateCourseCompliance] = useMutation(
    UPDATE_COURSE_COMPLIANCE_MUTATION
  );
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Toggle courses to include in compliance tracking
            </CardDescription>
          </CardHeader>
          <CardContent>
            {fetching && (
            ...
            {!fetching && courses.length === 0 && (
              <p className="text-muted-foreground text-sm">
                No compliance courses configured yet.
              </p>
            )}
              ...
              {courses.map((course) => (
                ...
                >
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => void handleToggleCompliance(course)}
                  >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select courses and generate a CSV + PDF compliance report
            </CardDescription>
          </CardHeader>
            ...
            {reportResult && (
              <div className="border rounded-lg p-4 bg-muted/30 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <span
                    className={
                      reportResult.summary.overdueCount > 0
