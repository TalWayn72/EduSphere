              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="contactEmail" type="email" {...register('contactEmail')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70" placeholder="jane@university.edu" aria-required="true" />
                ...
                <div>
                  ...
                  <Input id="estimatedUsers" type="number" min={1} max={1000000} {...register('estimatedUsers', { valueAsNumber: true })} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70" placeholder="500" aria-required="true" />
