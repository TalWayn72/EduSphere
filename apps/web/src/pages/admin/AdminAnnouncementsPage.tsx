    ...
    >
      ...
      <div data-testid="admin-announcements-page" className="space-y-4">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Card>
            <CardHeader>
              <CardTitle>{t('announcements.create')}</CardTitle>
            </CardHeader>
            <CardContent>
              <form
              ...
              >
                <div>
                  ...
                  <Input
                    ...
                    {...register('title', {
                      required: t('announcements.titleRequired'),
                    })}
                  />
                  {errors.title && (
                ...
                <div>
                  ...
                  <textarea
                    ...
                    {...register('body', {
                      required: t('announcements.bodyRequired'),
                    })}
                  />
                  {errors.body && (
                    <p className="text-xs text-destructive mt-1">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {showPreview
                      ? t('announcements.hidePreview')
                      : t('announcements.showPreview')}
                  </Button>
                </div>
              </form>
            </CardContent>
