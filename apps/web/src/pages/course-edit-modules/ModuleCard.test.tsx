...
vi.mock('@/components/ui/card', () => ({
  ...
  CardTitle: ({ children, onClick }: { children: React.ReactNode; onClick?: () => void; className?: string }) =>
...
const mod = {
  ...
  title: 'Module A',
  orderIndex: 0,
  contentItems: [{ id: 'ci-1', title: 'Item 1', contentType: 'VIDEO', duration: 300, orderIndex: 0 }],
};
...
describe('ModuleCard', () => {
  ...
  it('renders without crash when isLoading', () => {
    const { container } = render(<ModuleCard {...baseProps} isLoading={true} />);
