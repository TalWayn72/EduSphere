    ...
    <PublicLayout navVariant="minimal">
      <div data-testid="partner-signup-page" className="min-h-screen bg-gradient-to-br from-indigo-900 to-slate-900">
        ...
        <div className="bg-indigo-600/30 border border-indigo-400/40 rounded-xl p-5 mb-6 text-center">
          ...
          <p className="text-indigo-100 mt-1">70% goes to you as a partner</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          {Object.entries(PARTNER_TYPE_DESCRIPTIONS).map(([type, desc]) => (
            <div key={type} className="bg-white/10 border border-white/20 rounded-lg p-4">
              ...
              <p className="text-indigo-100 text-xs">{desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="bg-white/10 backdrop-blur rounded-2xl border border-white/20 p-8">
          {success ? (
            <div data-testid="partner-success-message" className="text-center py-8" role="status" aria-live="polite">
              ...
              <p className="text-indigo-100">Application received! We'll review and respond within 3 business days.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit(onSubmit)} noValidate>
              <div className="space-y-5">
                <div>
                  ...
                  <Input id="organizationName" {...register('organizationName')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/80" placeholder="Acme Corp" aria-required="true" />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="contactName" {...register('contactName')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/80" placeholder="Jane Smith" aria-required="true" />
                  ...
                  <div>
                    ...
                    <Input id="contactEmail" type="email" {...register('contactEmail')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/80" placeholder="jane@company.com" aria-required="true" />
                ...
                <div>
                  ...
                  <Input id="expectedLearners" type="number" min={1} {...register('expectedLearners', { valueAsNumber: true })} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/80" placeholder="1000" aria-required="true" />
                ...
                <div>
                  ...
                  <Textarea id="description" {...register('description')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/80 min-h-[80px]" placeholder="Tell us about your plans..." aria-required="true" />
