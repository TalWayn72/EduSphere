...
export function EnrollUserDialog({
  ...
  const handleEnroll = async () => {
    ...
    if (result.error) {
      console.error(
        '[EnrollmentManagement] Enroll failed:',
      ...
      <DialogContent className="max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Enroll a user in the selected course.
          </DialogDescription>
        </DialogHeader>
...
export function BulkEnrollDialog({
  ...
  const handleBulkEnroll = async () => {
    ...
    if (result.error) {
      console.error(
        '[EnrollmentManagement] Bulk enroll failed:',
        result.error.message
      );
    ...
    >
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Bulk enroll multiple users via CSV input.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-3 py-2">
