            ...
            <Card key={item.key} className="bg-white border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="pt-7 pb-6">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-slate-100">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 text-sm">{t(`landing.testimonials.${item.key}.name`)}</div>
                    <div className="text-xs text-slate-500">{t(`landing.testimonials.${item.key}.role`)}, {t(`landing.testimonials.${item.key}.org`)}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
