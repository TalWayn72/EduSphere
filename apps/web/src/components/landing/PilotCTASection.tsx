              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate aria-label="Pilot application form">
                <div className="space-y-5">
                  <div>
                    ...
                    <Input id="orgName" {...register('orgName')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70" placeholder="University of..." aria-required="true" />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="contactName" {...register('contactName')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70" placeholder="Dr. Jane Smith" aria-required="true" />
                      {errors.contactName && <p className="text-red-300 text-xs mt-1" role="alert">{errors.contactName.message}</p>}
                    </div>
                    <div>
                      <Label htmlFor="email" className="text-white text-sm font-medium">Email *</Label>
                      <Input id="email" type="email" {...register('email')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70" placeholder="jane@university.edu" aria-required="true" />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="phone" {...register('phone')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70" placeholder="+1 (555) 000-0000" />
                    </div>
                    <div>
                      <Label htmlFor="estimatedUsers" className="text-white text-sm font-medium">Estimated Users *</Label>
                      <Input id="estimatedUsers" type="number" {...register('estimatedUsers')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70" placeholder="500" aria-required="true" />
                  ...
                  <div>
                    ...
                    <Textarea id="useCase" {...register('useCase')} className="mt-1.5 bg-white/10 border-white/20 text-white placeholder:text-white/70 min-h-[80px]" placeholder="Describe your learning goals..." aria-required="true" />
