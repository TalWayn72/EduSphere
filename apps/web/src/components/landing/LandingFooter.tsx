  ...
  return [
    {
      ...
      links: [
        ...
        {
          label: t('landing.footer.aiCourseBuilder'),
          href: '/features/ai-course-builder',
        },
        {
          label: t('landing.footer.visualAnchoring'),
          href: '/features/visual-anchoring',
        },
        {
          label: t('landing.footer.knowledgeGraph'),
    ...
    },
    {
      ...
      links: [
        {
          label: t('landing.footer.universities'),
          href: '/solutions/universities',
        },
        {
          label: t('landing.footer.enterprises'),
          href: '/solutions/enterprises',
        },
        {
          label: t('landing.footer.governmentDefense'),
          href: '/solutions/government',
        },
        {
          label: t('landing.footer.trainingCompanies'),
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: t('landing.footer.airGapped'),
          href: '/compliance#air-gapped',
        },
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: t('landing.footer.accessibilityStatement'),
          href: '/accessibility',
        },
      ],
    },
...
export function LandingFooter() {
  ...
  return (
    <footer
      ...
      className="bg-slate-900 text-slate-400 pt-16 pb-8 dark:bg-slate-100 dark:text-slate-500"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Brand */}
        <div className="flex items-center gap-2 mb-10">
          <Brain
            className="h-7 w-7 text-indigo-400 dark:text-indigo-300"
            aria-hidden="true"
          />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {COLUMNS.map((col) => (
            <div key={col.heading}>
              <h4 className="text-white font-semibold text-sm mb-4 dark:text-white">
                {col.heading}
              </h4>
