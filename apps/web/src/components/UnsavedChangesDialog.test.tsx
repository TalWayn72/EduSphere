...
describe('UnsavedChangesDialog', () => {
  it('renders when open', () => {
    render(
      <UnsavedChangesDialog open={true} onLeave={vi.fn()} onStay={vi.fn()} />
    );
  ...
  it('does not render when closed', () => {
    render(
      <UnsavedChangesDialog open={false} onLeave={vi.fn()} onStay={vi.fn()} />
    );
    expect(
  ...
  it('calls onStay when stay button clicked', () => {
    const onStay = vi.fn();
    render(
      <UnsavedChangesDialog open={true} onLeave={vi.fn()} onStay={onStay} />
    );
  ...
  it('calls onLeave when leave button clicked', () => {
    const onLeave = vi.fn();
    render(
      <UnsavedChangesDialog open={true} onLeave={onLeave} onStay={vi.fn()} />
    );
