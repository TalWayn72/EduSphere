...
vi.mock('@/components/ui/card', () => ({ Card: (p: React.HTMLAttributes<HTMLDivElement>) => <div {...p} />, CardContent: (p: React.HTMLAttributes<HTMLDivElement>) => <div {...p} />, CardHeader: (p: React.HTMLAttributes<HTMLDivElement>) => <div {...p} />, CardTitle: (p: React.HTMLAttributes<HTMLHeadingElement>) => <h3 {...p} /> }));
vi.mock('@/components/ui/badge', () => ({ Badge: (p: React.HTMLAttributes<HTMLSpanElement>) => <span {...p} /> }));
vi.mock('@/components/ui/progress', () => ({ Progress: (p: { value?: number }) => <div role='progressbar' data-value={p.value} /> }));
vi.mock('@/components/ui/button', () => ({ Button: (p: React.ButtonHTMLAttributes<HTMLButtonElement>) => <button {...p} /> }));
