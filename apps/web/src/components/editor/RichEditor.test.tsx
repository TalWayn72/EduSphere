...
function renderEditor(
  ...
  return render(<RichEditor content="" onChange={vi.fn()} {...props} />);
}
...
describe('RichEditor', () => {
  ...
  it('returns null when editor not initialised', () => {
    vi.mocked(TiptapReact.useEditor).mockReturnValue(
  ...
  it('no toolbar in readOnly mode', () => {
  ...
  it('Math click calls insertContent', () => {
    renderEditor();
