...
vi.mock("@/components/ui/select", () => ({
  Select: ({ children }: { children: React.ReactNode }) => <div data-testid="select-root">{children}</div>,
...
describe("AIChatPanel", () => {
  ...
  it("shows mock chat history messages when open", () => {
    ...
    fireEvent.click(toggleBtn!);
    expect(
      screen.getByText(/What.s the relationship between free will and divine providence/i)
    ).toBeInTheDocument();
  });
