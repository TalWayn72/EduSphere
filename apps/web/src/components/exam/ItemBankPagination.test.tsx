...
describe('ItemBankPagination', () => {
  it('shows correct range text', () => {
    render(
      <ItemBankPagination page={0} pageSize={10} totalCount={45} onPageChange={vi.fn()} />,
    );
  ...
  it('shows correct range on middle page', () => {
    render(
      <ItemBankPagination page={2} pageSize={10} totalCount={45} onPageChange={vi.fn()} />,
    );
  ...
  it('clamps end to totalCount on last page', () => {
    render(
      <ItemBankPagination page={4} pageSize={10} totalCount={45} onPageChange={vi.fn()} />,
    );
  ...
  it('calls onPageChange with previous page', () => {
    ...
    render(
      <ItemBankPagination page={2} pageSize={10} totalCount={45} onPageChange={onChange} />,
    );
  ...
  it('handles zero items', () => {
    render(
      <ItemBankPagination page={0} pageSize={10} totalCount={0} onPageChange={vi.fn()} />,
    );
