...
import {
  MicrolessonCard,
  type MicrolessonData,
} from '@/components/MicrolessonCard';
...
function parseMicrolessonData(
  item: DailyMicrolessonQueryResult['dailyMicrolesson']
): MicrolessonData | null {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {completed ? 'All done for today!' : "Today's 3-7 minute microlesson"}
        </CardDescription>
      </CardHeader>
      <CardContent>
        {fetching && (
