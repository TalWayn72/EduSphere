...
export function AIChavrutaTyping() {
  ...
  const qChars = Math.floor(
    interpolate(frame, [20, 80], [0, QUESTION.length], {
      extrapolateLeft: 'clamp',
      extrapolateRight: 'clamp',
    })
  );
  const aChars = Math.floor(
    interpolate(frame, [100, 220], [0, ANSWER.length], {
      extrapolateLeft: 'clamp',
      extrapolateRight: 'clamp',
    })
  );

  const bubbleIn = interpolate(frame, [10, 25], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
  const aiBubbleIn = interpolate(frame, [90, 105], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
