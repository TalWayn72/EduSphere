...
const EDGES = [
  ...
  { from: 0, to: 2, delay: 75 },
  { from: 0, to: 3, delay: 105 },
  { from: 0, to: 4, delay: 135 },
  { from: 0, to: 5, delay: 165 },
  { from: 0, to: 6, delay: 195 },
  { from: 0, to: 7, delay: 225 },
  { from: 0, to: 8, delay: 255 },
  { from: 1, to: 7, delay: 270 },
  { from: 2, to: 4, delay: 282 },
  { from: 3, to: 5, delay: 294 },
  { from: 6, to: 8, delay: 306 },
];
...
function GraphNode({
  ...
  const labelOpacity = interpolate(lf, [15, 35], [0, 1], {
...
function GraphEdge({
  ...
  const dashOffset = interpolate(lf, [0, 25], [len, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
  const opacity = interpolate(lf, [0, 6], [0, 0.55], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
  return (
...
export function KnowledgeGraphGrow() {
  ...
  return (
    ...
    >
      ...
      >
        {EDGES.map((e, i) => (
          <GraphEdge key={i} edge={e} frame={frame} />
        ))}
        {NODES.map((n) => (
