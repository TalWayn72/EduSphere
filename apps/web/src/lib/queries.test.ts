...
describe('GraphQL query definitions', () => {
  it('ME_QUERY is defined and contains query Me', () => {
    ...
    const def = ME_QUERY.definitions[0] as {
      kind: string;
      operation?: string;
      name?: { value: string };
    };
  ...
  it('UPDATE_USER_PREFERENCES_MUTATION is a mutation', () => {
    ...
    expect(UPDATE_USER_PREFERENCES_MUTATION.definitions.length).toBeGreaterThan(
      0
    );
    const def = UPDATE_USER_PREFERENCES_MUTATION.definitions[0] as {
      kind: string;
      operation?: string;
      name?: { value: string };
    };
  ...
  it('TENANT_QUERY is a query named Tenant', () => {
    ...
    const def = TENANT_QUERY.definitions[0] as {
      kind: string;
      operation?: string;
      name?: { value: string };
    };
  ...
  it('COURSES_QUERY is a query named Courses', () => {
    ...
    const def = COURSES_QUERY.definitions[0] as {
      kind: string;
      operation?: string;
      name?: { value: string };
    };
  ...
  it('MY_STATS_QUERY is a query named MyStats', () => {
    ...
    const def = MY_STATS_QUERY.definitions[0] as {
      kind: string;
      operation?: string;
      name?: { value: string };
    };
