...
import { ADMIN_ANNOUNCEMENTS_QUERY, CREATE_ANNOUNCEMENT_MUTATION, UPDATE_ANNOUNCEMENT_MUTATION, DELETE_ANNOUNCEMENT_MUTATION, PUBLISH_ANNOUNCEMENT_MUTATION } from './announcements.queries';
...
describe('announcements.queries', () => {
  it('exports ADMIN_ANNOUNCEMENTS_QUERY as a query DocumentNode', () => {
    ...
    expect(ADMIN_ANNOUNCEMENTS_QUERY.definitions.length).toBeGreaterThanOrEqual(1);
    const def = ADMIN_ANNOUNCEMENTS_QUERY.definitions[0] as { kind: string; operation: string; name?: { value: string } };
  ...
  it('exports CREATE_ANNOUNCEMENT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(CREATE_ANNOUNCEMENT_MUTATION.definitions.length).toBeGreaterThanOrEqual(1);
    const def = CREATE_ANNOUNCEMENT_MUTATION.definitions[0] as { kind: string; operation: string; name?: { value: string } };
    expect(def.kind).toBe('OperationDefinition');
  ...
  it('exports UPDATE_ANNOUNCEMENT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(UPDATE_ANNOUNCEMENT_MUTATION.definitions.length).toBeGreaterThanOrEqual(1);
    const def = UPDATE_ANNOUNCEMENT_MUTATION.definitions[0] as { kind: string; operation: string; name?: { value: string } };
    expect(def.kind).toBe('OperationDefinition');
    expect(def.operation).toBe('mutation');
  ...
  it('exports DELETE_ANNOUNCEMENT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(DELETE_ANNOUNCEMENT_MUTATION.definitions.length).toBeGreaterThanOrEqual(1);
    const def = DELETE_ANNOUNCEMENT_MUTATION.definitions[0] as { kind: string; operation: string; name?: { value: string } };
    expect(def.kind).toBe('OperationDefinition');
    expect(def.operation).toBe('mutation');
  ...
  it('exports PUBLISH_ANNOUNCEMENT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(PUBLISH_ANNOUNCEMENT_MUTATION.definitions.length).toBeGreaterThanOrEqual(1);
    const def = PUBLISH_ANNOUNCEMENT_MUTATION.definitions[0] as { kind: string; operation: string; name?: { value: string } };
    expect(def.kind).toBe('OperationDefinition');
    expect(def.operation).toBe('mutation');
