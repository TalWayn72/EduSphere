...
describe('dashboard.queries', () => {
  it('exports MY_IN_PROGRESS_COURSES_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_IN_PROGRESS_COURSES_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_IN_PROGRESS_COURSES_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_RECOMMENDED_COURSES_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_RECOMMENDED_COURSES_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_RECOMMENDED_COURSES_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_ACTIVITY_FEED_QUERY as a query DocumentNode', () => {
    ...
    const def = MY_ACTIVITY_FEED_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_STATS_WITH_STREAK_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_STATS_WITH_STREAK_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_STATS_WITH_STREAK_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_TOP_MASTERY_TOPICS_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_TOP_MASTERY_TOPICS_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_TOP_MASTERY_TOPICS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
