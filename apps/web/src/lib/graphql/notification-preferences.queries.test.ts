...
import {
  ...
  MY_NOTIFICATION_HISTORY_QUERY,
  NOTIFICATION_DELIVERY_ANALYTICS_QUERY,
...
describe('notification-preferences.queries', () => {
  it('exports MY_NOTIFICATION_PREFERENCES_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_NOTIFICATION_PREFERENCES_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_NOTIFICATION_PREFERENCES_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UPDATE_NOTIFICATION_PREFERENCE_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      UPDATE_NOTIFICATION_PREFERENCE_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = UPDATE_NOTIFICATION_PREFERENCE_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_NOTIFICATION_HISTORY_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_NOTIFICATION_HISTORY_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_NOTIFICATION_HISTORY_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports NOTIFICATION_DELIVERY_ANALYTICS_QUERY as a query DocumentNode', () => {
    ...
    expect(
      NOTIFICATION_DELIVERY_ANALYTICS_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = NOTIFICATION_DELIVERY_ANALYTICS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MARK_NOTIFICATION_READ_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      MARK_NOTIFICATION_READ_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MARK_NOTIFICATION_READ_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MARK_ALL_NOTIFICATIONS_READ_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      MARK_ALL_NOTIFICATIONS_READ_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MARK_ALL_NOTIFICATIONS_READ_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
