...
describe('profile.queries', () => {
  it('exports PUBLIC_PROFILE_QUERY as a query DocumentNode', () => {
    ...
    const def = PUBLIC_PROFILE_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports FOLLOW_USER_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = FOLLOW_USER_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UNFOLLOW_USER_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = UNFOLLOW_USER_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UPDATE_PROFILE_VISIBILITY_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      UPDATE_PROFILE_VISIBILITY_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = UPDATE_PROFILE_VISIBILITY_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
