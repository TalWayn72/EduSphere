...
describe('portal.queries', () => {
  it('exports MY_PORTAL_QUERY as a query DocumentNode', () => {
    ...
    const def = MY_PORTAL_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports PUBLIC_PORTAL_QUERY as a query DocumentNode', () => {
    ...
    const def = PUBLIC_PORTAL_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports SAVE_PORTAL_LAYOUT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      SAVE_PORTAL_LAYOUT_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = SAVE_PORTAL_LAYOUT_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports PUBLISH_PORTAL_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(PUBLISH_PORTAL_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = PUBLISH_PORTAL_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UNPUBLISH_PORTAL_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(UNPUBLISH_PORTAL_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = UNPUBLISH_PORTAL_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
