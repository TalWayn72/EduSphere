...
import {
  ...
  MY_LIBRARY_ACTIVATIONS_QUERY,
  ACTIVATE_LIBRARY_COURSE_MUTATION,
  DEACTIVATE_LIBRARY_COURSE_MUTATION,
...
describe('library.queries', () => {
  ...
  it('exports MY_LIBRARY_ACTIVATIONS_QUERY as a query string', () => {
    ...
    expect(MY_LIBRARY_ACTIVATIONS_QUERY).toContain(
  ...
  it('exports ACTIVATE_LIBRARY_COURSE_MUTATION as a mutation string', () => {
    ...
    expect(ACTIVATE_LIBRARY_COURSE_MUTATION).toContain(
  ...
  it('exports DEACTIVATE_LIBRARY_COURSE_MUTATION as a mutation string', () => {
    ...
    expect(DEACTIVATE_LIBRARY_COURSE_MUTATION).toContain(
