...
describe('live-session.queries', () => {
  it('exports LIST_LIVE_SESSIONS_QUERY as a query DocumentNode', () => {
    ...
    expect(LIST_LIVE_SESSIONS_QUERY.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = LIST_LIVE_SESSIONS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports LIVE_SESSION_QUERY as a query DocumentNode', () => {
    ...
    const def = LIVE_SESSION_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports GET_LIVE_SESSION_QUERY as a query DocumentNode', () => {
    ...
    const def = GET_LIVE_SESSION_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_LIVE_SESSION_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      CREATE_LIVE_SESSION_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = CREATE_LIVE_SESSION_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports JOIN_LIVE_SESSION_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      JOIN_LIVE_SESSION_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = JOIN_LIVE_SESSION_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports START_LIVE_SESSION_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      START_LIVE_SESSION_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = START_LIVE_SESSION_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CANCEL_LIVE_SESSION_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      CANCEL_LIVE_SESSION_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = CANCEL_LIVE_SESSION_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports END_LIVE_SESSION_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(END_LIVE_SESSION_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = END_LIVE_SESSION_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports SESSION_POLLS_QUERY as a query DocumentNode', () => {
    ...
    const def = SESSION_POLLS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports POLL_RESULTS_QUERY as a query DocumentNode', () => {
    ...
    const def = POLL_RESULTS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_POLL_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = CREATE_POLL_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports ACTIVATE_POLL_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = ACTIVATE_POLL_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CLOSE_POLL_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = CLOSE_POLL_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports VOTE_POLL_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = VOTE_POLL_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports POLL_UPDATED_SUBSCRIPTION as a subscription DocumentNode', () => {
    ...
    expect(POLL_UPDATED_SUBSCRIPTION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = POLL_UPDATED_SUBSCRIPTION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports BREAKOUT_ROOMS_QUERY as a query DocumentNode', () => {
    ...
    const def = BREAKOUT_ROOMS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_BREAKOUT_ROOMS_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      CREATE_BREAKOUT_ROOMS_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = CREATE_BREAKOUT_ROOMS_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
