...
import { SKILL_GAP_ANALYSIS_QUERY, SKILL_PROFILES_QUERY, CREATE_SKILL_PROFILE_MUTATION, SOCIAL_RECOMMENDATIONS_QUERY, SOCIAL_FEED_QUERY } from './knowledge-tier3.queries';
