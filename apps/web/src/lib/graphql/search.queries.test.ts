...
describe('search.queries', () => {
  it('exports SAVED_SEARCHES_QUERY as a query DocumentNode', () => {
    ...
    const def = SAVED_SEARCHES_QUERY.definitions[0] as { kind: string; operation: string; name?: { value: string } };
  ...
  it('exports CREATE_SAVED_SEARCH_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = CREATE_SAVED_SEARCH_MUTATION.definitions[0] as { kind: string; operation: string; name?: { value: string } };
    expect(def.kind).toBe('OperationDefinition');
  ...
  it('exports DELETE_SAVED_SEARCH_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = DELETE_SAVED_SEARCH_MUTATION.definitions[0] as { kind: string; operation: string; name?: { value: string } };
    expect(def.kind).toBe('OperationDefinition');
    expect(def.operation).toBe('mutation');
