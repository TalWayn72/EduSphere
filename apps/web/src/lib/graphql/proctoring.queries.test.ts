...
import {
  ...
  GET_PROCTORING_REPORT_QUERY,
} from './proctoring.queries';
...
describe('proctoring.queries', () => {
  it('exports START_PROCTORING_SESSION_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      START_PROCTORING_SESSION_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = START_PROCTORING_SESSION_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports FLAG_PROCTORING_EVENT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      FLAG_PROCTORING_EVENT_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = FLAG_PROCTORING_EVENT_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports END_PROCTORING_SESSION_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      END_PROCTORING_SESSION_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = END_PROCTORING_SESSION_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports GET_PROCTORING_REPORT_QUERY as a query DocumentNode', () => {
    ...
    expect(
      GET_PROCTORING_REPORT_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = GET_PROCTORING_REPORT_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
