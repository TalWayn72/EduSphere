...
describe('exam.operations', () => {
  it('exports EXAM_ITEM_BANK_QUERY as a query DocumentNode', () => {
    ...
    const def = EXAM_ITEM_BANK_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports EXAM_ITEM_QUERY as a query DocumentNode', () => {
    ...
    const def = EXAM_ITEM_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_EXAM_ITEM_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(CREATE_EXAM_ITEM_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = CREATE_EXAM_ITEM_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UPDATE_EXAM_ITEM_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(UPDATE_EXAM_ITEM_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = UPDATE_EXAM_ITEM_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports RETIRE_EXAM_ITEM_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(RETIRE_EXAM_ITEM_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = RETIRE_EXAM_ITEM_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports GENERATE_EXAM_ITEMS_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      GENERATE_EXAM_ITEMS_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = GENERATE_EXAM_ITEMS_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports EXAM_BLUEPRINTS_QUERY as a query DocumentNode', () => {
    ...
    const def = EXAM_BLUEPRINTS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports EXAM_BLUEPRINT_QUERY as a query DocumentNode', () => {
    ...
    const def = EXAM_BLUEPRINT_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_EXAM_BLUEPRINT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      CREATE_EXAM_BLUEPRINT_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = CREATE_EXAM_BLUEPRINT_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UPDATE_EXAM_BLUEPRINT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      UPDATE_EXAM_BLUEPRINT_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = UPDATE_EXAM_BLUEPRINT_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports COURSE_MODULES_QUERY as a query DocumentNode', () => {
    ...
    const def = COURSE_MODULES_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
