...
import {
  ...
  PUBLIC_BRANDING_QUERY,
  BRANDED_LOGIN_DATA_QUERY,
...
describe('branding.queries', () => {
  it('exports TENANT_BRANDING_QUERY as a query DocumentNode', () => {
    ...
    const def = TENANT_BRANDING_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports PUBLIC_BRANDING_QUERY as a query DocumentNode', () => {
    ...
    const def = PUBLIC_BRANDING_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports BRANDED_LOGIN_DATA_QUERY as a query DocumentNode', () => {
    ...
    expect(BRANDED_LOGIN_DATA_QUERY.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = BRANDED_LOGIN_DATA_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UPDATE_TENANT_BRANDING_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      UPDATE_TENANT_BRANDING_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = UPDATE_TENANT_BRANDING_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
