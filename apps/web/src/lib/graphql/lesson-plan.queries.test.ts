...
describe('lesson-plan.queries', () => {
  it('exports MY_COURSE_LESSON_PLANS_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_COURSE_LESSON_PLANS_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_COURSE_LESSON_PLANS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports COURSE_LESSON_PLAN_QUERY as a query DocumentNode', () => {
    ...
    expect(COURSE_LESSON_PLAN_QUERY.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = COURSE_LESSON_PLAN_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_LESSON_PLAN_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      CREATE_LESSON_PLAN_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = CREATE_LESSON_PLAN_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports ADD_LESSON_STEP_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(ADD_LESSON_STEP_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = ADD_LESSON_STEP_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports REORDER_LESSON_STEPS_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      REORDER_LESSON_STEPS_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = REORDER_LESSON_STEPS_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports PUBLISH_LESSON_PLAN_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      PUBLISH_LESSON_PLAN_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = PUBLISH_LESSON_PLAN_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
