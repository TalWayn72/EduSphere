...
import {
  ...
  LEADERBOARD_QUERY,
  MY_RANK_QUERY,
  MY_TOTAL_POINTS_QUERY,
  MY_GAMIFICATION_STATS_QUERY,
...
describe('gamification.queries', () => {
  it('exports MY_BADGES_QUERY as a query DocumentNode', () => {
    ...
    const def = MY_BADGES_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports LEADERBOARD_QUERY as a query DocumentNode', () => {
    ...
    const def = LEADERBOARD_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_RANK_QUERY as a query DocumentNode', () => {
    ...
    const def = MY_RANK_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_TOTAL_POINTS_QUERY as a query DocumentNode', () => {
    ...
    const def = MY_TOTAL_POINTS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_GAMIFICATION_STATS_QUERY as a query DocumentNode', () => {
    ...
    expect(
      MY_GAMIFICATION_STATS_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = MY_GAMIFICATION_STATS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports TENANT_LEADERBOARD_QUERY as a query DocumentNode', () => {
    ...
    expect(TENANT_LEADERBOARD_QUERY.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = TENANT_LEADERBOARD_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
