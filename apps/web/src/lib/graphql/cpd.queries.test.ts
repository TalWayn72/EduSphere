...
describe('cpd.queries', () => {
  it('exports MY_CPD_REPORT_QUERY as a query DocumentNode', () => {
    ...
    const def = MY_CPD_REPORT_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CPD_CREDIT_TYPES_QUERY as a query DocumentNode', () => {
    ...
    const def = CPD_CREDIT_TYPES_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports EXPORT_CPD_REPORT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      EXPORT_CPD_REPORT_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = EXPORT_CPD_REPORT_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_CPD_CREDIT_TYPE_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      CREATE_CPD_CREDIT_TYPE_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = CREATE_CPD_CREDIT_TYPE_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports ASSIGN_CPD_CREDITS_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      ASSIGN_CPD_CREDITS_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = ASSIGN_CPD_CREDITS_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
