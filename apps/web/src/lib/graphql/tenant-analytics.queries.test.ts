...
describe('tenant-analytics.queries', () => {
  it('exports TENANT_ANALYTICS_QUERY as a query DocumentNode', () => {
    ...
    const def = TENANT_ANALYTICS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports LEARNER_VELOCITY_QUERY as a query DocumentNode', () => {
    ...
    const def = LEARNER_VELOCITY_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports COHORT_RETENTION_QUERY as a query DocumentNode', () => {
    ...
    const def = COHORT_RETENTION_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports EXPORT_TENANT_ANALYTICS_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      EXPORT_TENANT_ANALYTICS_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = EXPORT_TENANT_ANALYTICS_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
