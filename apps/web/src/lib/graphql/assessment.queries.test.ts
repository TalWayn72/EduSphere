...
import { MY_CAMPAIGNS_QUERY, CAMPAIGNS_TO_RESPOND_QUERY, CREATE_CAMPAIGN_MUTATION, ACTIVATE_CAMPAIGN_MUTATION, COMPLETE_CAMPAIGN_MUTATION, ASSESSMENT_RESULT_QUERY, SUBMIT_RESPONSE_MUTATION } from './assessment.queries';
...
describe('assessment.queries', () => {
  ...
  it('exports CREATE_CAMPAIGN_MUTATION as a mutation string', () => {
    ...
    expect(CREATE_CAMPAIGN_MUTATION).toContain('mutation CreateAssessmentCampaign');
  });
  ...
  it('exports SUBMIT_RESPONSE_MUTATION as a mutation string', () => {
    ...
    expect(SUBMIT_RESPONSE_MUTATION).toContain('mutation SubmitAssessmentResponse');
  });
