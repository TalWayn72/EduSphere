...
import {
  ...
  UPDATE_SKILL_PROGRESS_MUTATION,
} from './skills.queries';
...
describe('skills.queries', () => {
  it('exports SKILLS_QUERY as a query DocumentNode', () => {
    ...
    const def = SKILLS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports SKILL_PATHS_QUERY as a query DocumentNode', () => {
    ...
    const def = SKILL_PATHS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports MY_SKILL_PROGRESS_QUERY as a query DocumentNode', () => {
    ...
    expect(MY_SKILL_PROGRESS_QUERY.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = MY_SKILL_PROGRESS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UPDATE_SKILL_PROGRESS_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      UPDATE_SKILL_PROGRESS_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = UPDATE_SKILL_PROGRESS_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
