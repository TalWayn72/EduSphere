...
describe('knowledge.queries', () => {
  it('exports CONCEPT_QUERY as a query DocumentNode', () => {
    ...
    const def = CONCEPT_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports GET_CONCEPTS_QUERY as a query DocumentNode', () => {
    ...
    const def = GET_CONCEPTS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports GET_RELATED_CONCEPTS_QUERY as a query DocumentNode', () => {
    ...
    expect(
      GET_RELATED_CONCEPTS_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = GET_RELATED_CONCEPTS_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports CREATE_CONCEPT_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(CREATE_CONCEPT_MUTATION.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = CREATE_CONCEPT_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports LINK_CONCEPTS_MUTATION as a mutation DocumentNode', () => {
    ...
    const def = LINK_CONCEPTS_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports SEARCH_SEMANTIC_QUERY as a query DocumentNode', () => {
    ...
    const def = SEARCH_SEMANTIC_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports LEARNING_PATH_QUERY as a query DocumentNode', () => {
    ...
    const def = LEARNING_PATH_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports RELATED_CONCEPTS_BY_NAME_QUERY as a query DocumentNode', () => {
    ...
    expect(
      RELATED_CONCEPTS_BY_NAME_QUERY.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = RELATED_CONCEPTS_BY_NAME_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports PREREQUISITE_CHAIN_QUERY as a query DocumentNode', () => {
    ...
    expect(PREREQUISITE_CHAIN_QUERY.definitions.length).toBeGreaterThanOrEqual(
      1
    );
    const def = PREREQUISITE_CHAIN_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports GET_SKILL_TREE_QUERY as a query DocumentNode', () => {
    ...
    const def = GET_SKILL_TREE_QUERY.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
  ...
  it('exports UPDATE_MASTERY_LEVEL_MUTATION as a mutation DocumentNode', () => {
    ...
    expect(
      UPDATE_MASTERY_LEVEL_MUTATION.definitions.length
    ).toBeGreaterThanOrEqual(1);
    const def = UPDATE_MASTERY_LEVEL_MUTATION.definitions[0] as {
      kind: string;
      operation: string;
      name?: { value: string };
    };
