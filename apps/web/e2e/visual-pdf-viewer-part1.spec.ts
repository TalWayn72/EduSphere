...
test.describe('Visual Regression — PDF Viewer @visual-pdf', () => {
  ...
  test('pdf viewer — page navigation controls', async ({ page }) => {
    ...
    const pagination = page
      .locator(
        '[data-testid="pdf-pagination"], [data-testid="page-nav"], .page-controls, nav'
      )
      .first();
    await screenshotElOrPage(
      pagination,
      page,
      'pdf-viewer-pagination-controls.png',
      {
        ...LOOSE_OPTS,
        fullPage: false,
      }
  ...
  test('pdf viewer — second page view', async ({ page }) => {
    ...
    const nextPage = page
      .locator(
        '[data-testid="next-page"], [aria-label="Next page"], button:has-text("Next")'
      )
      .first();
  ...
  test('pdf viewer — with annotations overlay', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot(
      'pdf-viewer-annotations-overlay.png',
      LOOSE_OPTS
    );
  });
  ...
  test('pdf viewer — annotation highlight detail', async ({ page }) => {
    ...
    const highlight = page
      .locator(
        '[data-testid="annotation-marker"], .annotation-highlight, .highlight-marker'
      )
      .first();
    ...
    await expect(page).toHaveScreenshot(
      'pdf-viewer-annotation-detail.png',
      LOOSE_OPTS
    );
  });
  ...
  test('pdf viewer — sidebar table of contents', async ({ page }) => {
    ...
    const sidebar = page
      .locator('[data-testid="pdf-sidebar"], aside, [role="complementary"]')
      .first();
  ...
  test('pdf viewer — course content page with PDF listing', async ({
    page,
  }) => {
    await goTo(page, '/learn/courses/c1');
    await expect(page).toHaveScreenshot(
      'pdf-viewer-course-content.png',
      LOOSE_OPTS
    );
  });
  ...
  test('pdf viewer — mobile viewport portrait', async ({ page }) => {
    ...
    await goTo(page, '/learn/courses/c1/lessons/lesson-pdf-1');
    await expect(page).toHaveScreenshot(
      'pdf-viewer-mobile-portrait.png',
      LOOSE_OPTS
    );
  });
  ...
  test('pdf viewer — mobile viewport landscape', async ({ page }) => {
    ...
    await goTo(page, '/learn/courses/c1/lessons/lesson-pdf-1');
    await expect(page).toHaveScreenshot(
      'pdf-viewer-mobile-landscape.png',
      LOOSE_OPTS
    );
  });
