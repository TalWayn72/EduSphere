...
test.describe('Visual Interactions — Modals & Dialogs (Part 1)', () => {
  ...
  test.describe('Confirmation dialogs', () => {
    test('delete confirmation dialog on courses', async ({ page }) => {
      ...
      const deleteBtn = page
        .locator(
          '[data-testid="delete-course"], button:has-text("Delete"), [aria-label*="delete"]'
        )
        .first();
      ...
      await screenshotElement(
        ...
        'interact-modals-courses-delete-confirm.png'
      );
    });
    ...
    test('logout confirmation dialog', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const avatar = page
        .locator('[data-testid="user-menu"], [data-testid="user-avatar"]')
        .first();
      if (await avatar.isVisible({ timeout: 3000 }).catch(() => false)) {
        ...
        const logoutItem = page
          .locator(
            '[data-testid="logout-btn"], [role="menuitem"]:has-text("Logout"), [role="menuitem"]:has-text("Sign out")'
          )
          .first();
      ...
      await screenshotElement(
        ...
        'interact-modals-dashboard-logout-confirm.png'
      );
    });
    ...
    test('discard changes confirmation', async ({ page }) => {
      ...
      const backBtn = page
        .locator(
          '[data-testid="back-btn"], a:has-text("Back"), [aria-label*="back"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="alertdialog"], [role="dialog"]',
        'interact-modals-course-discard-confirm.png'
      );
    });
    ...
    test('confirmation dialog cancel button hover', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const deleteBtn = page
        .locator('[data-testid="delete-course"], button:has-text("Delete")')
        .first();
      if (await deleteBtn.isVisible({ timeout: 3000 }).catch(() => false)) {
        await deleteBtn.click();
        await page.waitForTimeout(300);
      ...
      await screenshotElement(
        page,
        '[role="alertdialog"], [role="dialog"]',
        'interact-modals-courses-cancel-hover.png'
      );
    });
  });
  ...
  test.describe('Sheets and drawers', () => {
    test('course publish sheet', async ({ page }) => {
      ...
      const publishBtn = page
        .locator(
          '[data-testid="publish-btn"], button:has-text("Publish"), [aria-label*="publish"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[data-testid="publish-sheet"], [role="dialog"], [data-state="open"]',
        'interact-modals-course-publish-sheet.png'
      );
    });
    ...
    test('filter drawer on courses', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="filter-drawer"], [role="dialog"], [data-state="open"]',
        'interact-modals-courses-filter-drawer.png'
      );
    });
    ...
    test('mobile sheet on small viewport', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const filterBtn = page
        .locator('[data-testid="filter-btn"], button:has-text("Filter")')
        .first();
      if (await filterBtn.isVisible({ timeout: 3000 }).catch(() => false)) {
        await filterBtn.click();
        await page.waitForTimeout(400);
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-mobile-filter-sheet.png',
        STABLE_OPTS
      );
    });
    ...
    test('settings drawer', async ({ page }) => {
      ...
      const advancedBtn = page
        .locator(
          '[data-testid="advanced-settings"], button:has-text("Advanced"), [aria-label*="advanced"]'
        )
        .first();
      ...
      await screenshotElement(
        ...
        'interact-modals-settings-advanced-drawer.png'
      );
    });
  });
  ...
  test.describe('Toast notifications', () => {
    test('success toast', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-sonner-toast], [role="alert"], [data-testid="toast-success"]',
        'interact-modals-toast-success.png'
      );
    });
    ...
    test('error toast via GraphQL error', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-sonner-toast], [role="alert"], [data-testid="toast-error"]',
        'interact-modals-toast-error.png'
      );
    });
    ...
    test('warning toast', async ({ page }) => {
      ...
      await page.evaluate(() => {
        const event = new CustomEvent('show-toast', {
          detail: { type: 'warning', message: 'Session expiring soon' },
        });
      ...
      await screenshotElement(
        page,
        '[data-sonner-toast], [role="alert"], [data-testid="toast-warning"]',
        'interact-modals-toast-warning.png'
      );
    });
    ...
    test('info toast', async ({ page }) => {
      ...
      await page.evaluate(() => {
        const event = new CustomEvent('show-toast', {
          detail: { type: 'info', message: 'New features available' },
        });
        window.dispatchEvent(event);
      });
      await page.waitForTimeout(500);
      await screenshotElement(
        page,
        '[data-sonner-toast], [role="alert"], [data-testid="toast-info"]',
        'interact-modals-toast-info.png'
      );
    });
    ...
    test('multiple toasts stacked', async ({ page }) => {
        ...
        for (const type of ['success', 'error', 'warning']) {
          window.dispatchEvent(
            new CustomEvent('show-toast', {
              detail: { type, message: `${type} notification` },
            })
          );
        }
      });
      ...
      await screenshotElement(
        page,
        '[data-sonner-toaster], [data-testid="toast-container"]',
        'interact-modals-toast-stacked.png'
      );
    });
  });
  ...
  test.describe('Alert banners', () => {
    test('alert banner on dashboard', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[role="alert"], [data-testid="alert-banner"], .alert',
        'interact-modals-dashboard-alert-banner.png'
      );
    });
    ...
    test('dismissible alert after close', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const closeBtn = page
        .locator('[role="alert"] button, [data-testid="alert-close"]')
        .first();
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-dashboard-alert-dismissed.png',
        STABLE_OPTS
      );
    });
  });
  ...
  test.describe('Tooltip hover states', () => {
    test('tooltip on dashboard icon', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const iconBtn = page
        .locator('[data-tooltip], [aria-describedby], button[title]')
        .first();
      ...
      await screenshotElement(
        ...
        'interact-modals-dashboard-tooltip.png'
      );
    });
    ...
    test('tooltip on nav icon', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const navIcon = page
        .locator('nav button[title], nav [data-tooltip], aside button[title]')
        .first();
      ...
      await screenshotElement(
        page,
        '[role="tooltip"], [data-state="open"]',
        'interact-modals-nav-tooltip.png'
      );
    });
    ...
    test('tooltip on course card action', async ({ page }) => {
      ...
      const actionBtn = page
        .locator(
          '[data-testid="course-card"] button[title], [data-testid="course-card"] [data-tooltip]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="tooltip"], [data-state="open"]',
        'interact-modals-courses-card-tooltip.png'
      );
    });
    ...
    test('tooltip on analytics chart', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const chartEl = page
        .locator('[data-tooltip], [data-testid="chart"] [title]')
        .first();
      ...
      await screenshotElement(
        page,
        '[role="tooltip"], [data-state="open"]',
        'interact-modals-analytics-chart-tooltip.png',
        LOOSE_OPTS
      );
    });
  });
