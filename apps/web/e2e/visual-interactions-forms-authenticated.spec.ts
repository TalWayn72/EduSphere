...
test.describe('Visual Interactions — Forms (Authenticated)', () => {
  ...
  test.describe('Course creation form', () => {
    test('empty form initial state', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-forms-course-create-empty.png',
        STABLE_OPTS
      );
    });
    ...
    test('title input focused', async ({ page }) => {
      ...
      const title = page
        .locator(
          'input[name="title"], input[name="name"], [data-testid="course-title"]'
        )
        .first();
      ...
      await screenshotElement(
        ...
        'interact-forms-course-title-focused.png'
      );
    });
    ...
    test('validation errors on empty submit', async ({ page }) => {
      ...
      const submitBtn = page
        .locator(
          'button[type="submit"], [data-testid="submit-btn"], button:has-text("Create")'
        )
        .first();
      ...
      await expect(page).toHaveScreenshot(
        'interact-forms-course-validation-errors.png',
        STABLE_OPTS
      );
    });
    ...
    test('description textarea focused', async ({ page }) => {
      ...
      const desc = page
        .locator(
          'textarea[name="description"], [data-testid="course-description"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        'form, [data-testid="course-form"], main',
        'interact-forms-course-desc-focused.png'
      );
    });
    ...
    test('category select open', async ({ page }) => {
      ...
      const select = page
        .locator(
          '[data-testid="category-select"], select[name="category"], [role="combobox"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="listbox"], [data-state="open"], select',
        'interact-forms-course-category-open.png'
      );
    });
    ...
    test('difficulty select open', async ({ page }) => {
      ...
      const select = page
        .locator(
          '[data-testid="difficulty-select"], select[name="difficulty"], [role="combobox"]'
        )
        .nth(1);
      if (await select.isVisible({ timeout: 3000 }).catch(() => false)) {
        await select.click();
      ...
      await screenshotElement(
        ...
        'interact-forms-course-difficulty-open.png'
      );
    });
    ...
    test('form partially filled', async ({ page }) => {
      ...
      await page.waitForTimeout(200);
      await expect(page).toHaveScreenshot(
        'interact-forms-course-partial-fill.png',
        STABLE_OPTS
      );
    });
  });
  ...
  test.describe('Settings form', () => {
    test('settings page default state', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-forms-settings-default.png',
        STABLE_OPTS
      );
    });
    ...
    test('toggle switch off state', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[role="switch"], [data-testid="toggle"], input[type="checkbox"]',
        'interact-forms-settings-toggle-off.png'
      );
    });
    ...
    test('toggle switch on state', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const toggle = page
        .locator('[role="switch"], [data-testid="toggle"]')
        .first();
      ...
      await screenshotElement(
        ...
        'interact-forms-settings-toggle-on.png'
      );
    });
    ...
    test('checkbox unchecked state', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-forms-settings-checkbox-unchecked.png'
      );
    });
    ...
    test('checkbox checked state', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        'input[type="checkbox"], [role="checkbox"]',
        'interact-forms-settings-checkbox-checked.png'
      );
    });
    ...
    test('radio button states', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-forms-settings-radio-selected.png'
      );
    });
    ...
    test('settings theme select open', async ({ page }) => {
      ...
      const themeSelect = page
        .locator(
          '[data-testid="theme-select"], [aria-label*="theme"], [role="combobox"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="listbox"], [data-state="open"]',
        'interact-forms-settings-theme-open.png'
      );
    });
  });
  ...
  test.describe('Profile form', () => {
    test('profile page default state', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-forms-profile-default.png',
    ...
    test('profile name input focused', async ({ page }) => {
      ...
      const name = page
        .locator(
          'input[name="name"], input[name="displayName"], [data-testid="profile-name"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        'form, [data-testid="profile-form"], main',
        'interact-forms-profile-name-focused.png'
      );
    });
    ...
    test('profile bio textarea focused', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const bio = page
        .locator('textarea[name="bio"], [data-testid="profile-bio"]')
        .first();
      ...
      await screenshotElement(
        page,
        'form, [data-testid="profile-form"], main',
        'interact-forms-profile-bio-focused.png'
      );
    });
    ...
    test('profile avatar upload area', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="avatar-upload"], [data-testid="file-upload"], input[type="file"]',
        'interact-forms-profile-avatar-upload.png'
      );
    });
    ...
    test('profile validation errors on empty name', async ({ page }) => {
      ...
      const submitBtn = page
        .locator('button[type="submit"], [data-testid="save-profile"]')
        .first();
      if (await submitBtn.isVisible({ timeout: 3000 }).catch(() => false)) {
        await submitBtn.click();
        await page.waitForTimeout(500);
      ...
      await expect(page).toHaveScreenshot(
        'interact-forms-profile-validation-error.png',
        STABLE_OPTS
      );
    });
    ...
    test('profile date picker open', async ({ page }) => {
      ...
      const datePicker = page
        .locator(
          '[data-testid="date-picker"], input[type="date"], [aria-label*="date"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="dialog"], [data-testid="calendar"], .rdp',
        'interact-forms-profile-datepicker-open.png'
      );
    });
  });
  ...
  test.describe('File upload', () => {
    test('file upload area default', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="file-upload"], [data-testid="dropzone"], .dropzone',
        'interact-forms-course-upload-default.png'
      );
    });
    ...
    test('file upload drag hover simulation', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="file-upload"], [data-testid="dropzone"], .dropzone',
        'interact-forms-course-upload-drag-hover.png'
      );
    });
  });
  ...
  test.describe('Form submission feedback', () => {
    test('success toast after form action', async ({ page }) => {
      ...
      const saveBtn = page
        .locator(
          'button[type="submit"], [data-testid="save-btn"], button:has-text("Save")'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[data-testid="toast"], [role="alert"], [data-sonner-toast]',
        'interact-forms-settings-success-toast.png'
      );
    });
    ...
    test('error feedback on failed submission', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-forms-settings-error-feedback.png',
        STABLE_OPTS
      );
    });
  });
