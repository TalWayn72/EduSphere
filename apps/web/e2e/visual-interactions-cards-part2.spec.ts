...
test.describe('Visual Interactions — Cards', () => {
  ...
  test.describe('Assessment cards', () => {
    test('assessment card default', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="assessment-card"], [data-testid="exam-card"], article',
        'interact-cards-assessment-default.png',
        LOOSE_OPTS
      );
    });
    ...
    test('assessment card upcoming', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="assessment-card"][data-status="upcoming"], [data-status="upcoming"]',
        'interact-cards-assessment-upcoming.png',
        LOOSE_OPTS
      );
    });
    ...
    test('assessment card completed with score', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="assessment-card"][data-status="completed"], [data-status="graded"]',
        'interact-cards-assessment-completed.png',
        LOOSE_OPTS
      );
    });
    ...
    test('assessment card hover', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const card = page
        .locator('[data-testid="assessment-card"], [data-testid="exam-card"]')
        .first();
      ...
      await screenshotElement(
        page,
        '[data-testid="assessment-card"], [data-testid="exam-card"]',
        'interact-cards-assessment-hover.png',
        LOOSE_OPTS
      );
    });
    ...
    test('assessment card keyboard focus', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-cards-assessment-keyboard-focus.png',
        STABLE_OPTS
      );
    });
    ...
    test('assessment card mobile layout', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="assessment-card"], [data-testid="exam-card"], article',
        'interact-cards-assessment-mobile.png',
        LOOSE_OPTS
      );
    });
  });
  ...
  test.describe('Card tablet layouts', () => {
    test('course cards at tablet viewport', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-courses-tablet.png',
        LOOSE_OPTS
      );
    });
    ...
    test('challenge cards at tablet viewport', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-challenges-tablet.png',
        LOOSE_OPTS
      );
    });
    ...
    test('achievements at tablet viewport', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-achievements-tablet.png',
        LOOSE_OPTS
      );
    });
    ...
    test('notifications at tablet viewport', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-notifications-tablet.png',
    ...
    test('social feed at tablet viewport', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot('interact-cards-social-tablet.png', {
        ...LOOSE_OPTS,
    ...
    test('exams at tablet viewport', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-exams-tablet.png',
        LOOSE_OPTS
      );
    });
  });
  ...
  test.describe('Card wide desktop layouts', () => {
    test('course cards at wide desktop', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-courses-wide.png',
        LOOSE_OPTS
      );
    });
    ...
    test('achievements at wide desktop', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-achievements-wide.png',
        LOOSE_OPTS
      );
    });
    ...
    test('social feed at wide desktop', async ({ page }) => {
      ...
      await page.goto('/social', { waitUntil: 'domcontentloaded' });
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot('interact-cards-social-wide.png', {
        ...LOOSE_OPTS,
        mask: dynamicMasks(page),
      });
    });
    ...
    test('notifications at wide desktop', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-cards-notifications-wide.png',
        { ...LOOSE_OPTS, mask: dynamicMasks(page) }
      );
    });
  });
  ...
  test.describe('Card page sections', () => {
    test('courses page header section', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const header = page
        .locator('header, nav, [data-testid="page-header"]')
        .first();
      if (await header.isVisible({ timeout: 3000 }).catch(() => false)) {
        await expect(header).toHaveScreenshot(
          'interact-cards-courses-header.png',
          STABLE_OPTS
        );
      }
    });
    ...
    test('achievements page header section', async ({ page }) => {
      ...
      if (await header.isVisible({ timeout: 3000 }).catch(() => false)) {
        await expect(header).toHaveScreenshot(
          'interact-cards-achievements-header.png',
          STABLE_OPTS
        );
      }
    });
    ...
    test('social page sidebar section', async ({ page }) => {
      ...
      const sidebar = page
        .locator(
          'aside, [data-testid="social-sidebar"], [role="complementary"]'
        )
        .first();
      if (await sidebar.isVisible({ timeout: 3000 }).catch(() => false)) {
        await expect(sidebar).toHaveScreenshot(
          'interact-cards-social-sidebar.png',
          STABLE_OPTS
        );
      }
    });
    ...
    test('courses page main content', async ({ page }) => {
      ...
      if (await main.isVisible({ timeout: 3000 }).catch(() => false)) {
        await expect(main).toHaveScreenshot(
          'interact-cards-courses-main-area.png',
          LOOSE_OPTS
        );
      }
    });
