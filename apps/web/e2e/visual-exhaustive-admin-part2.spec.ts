...
test('admin desktop sidebar', async ({ page }) => {
  ...
  await snapEl(
    page,
    'aside, [data-testid="sidebar"], [role="complementary"]',
    'admin-desktop-sidebar.png'
  );
});
...
test('compliance desktop sidebar', async ({ page }) => {
  ...
  await snapEl(
    page,
    'aside, [data-testid="sidebar"], [role="complementary"]',
    'compliance-desktop-sidebar.png'
  );
});
...
test('lti desktop action-buttons', async ({ page }) => {
  ...
  await snapEl(
    page,
    '[data-testid="action-buttons"], .action-bar, footer button',
    'lti-desktop-actions.png'
  );
});
...
test('settings tablet breadcrumbs', async ({ page }) => {
  ...
  await snapEl(
    page,
    'nav[aria-label*="bread"], [data-testid="breadcrumbs"]',
    'settings-tablet-breadcrumbs.png'
  );
});
...
test('tenants desktop stats-cards', async ({ page }) => {
  ...
  await snapEl(
    page,
    '[data-testid="stats-cards"], [data-testid="stat-card"], .stats-grid',
    'tenants-desktop-stats.png'
  );
});
