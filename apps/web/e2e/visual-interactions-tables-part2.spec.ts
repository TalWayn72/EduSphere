...
test.describe('Visual Interactions — Tables (Part 2)', () => {
  ...
  test.describe('Exams item bank', () => {
    test('item bank table default', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        'table, [data-testid="item-bank-table"], [role="grid"]',
        'interact-tables-exams-itembank-default.png',
        LOOSE_OPTS
      );
    });
    ...
    test('item bank sort by difficulty', async ({ page }) => {
      await page.goto('/exams/item-bank', { waitUntil: 'domcontentloaded' });
      await page.waitForTimeout(500);
      const diffHeader = page
        .locator('th:has-text("Difficulty"), [data-testid="col-difficulty"]')
        .first();
      ...
      await screenshotElement(
        page,
        'table, [data-testid="item-bank-table"]',
        'interact-tables-exams-itembank-sort-difficulty.png',
        LOOSE_OPTS
      );
    });
    ...
    test('item bank row hover', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        'table, [data-testid="item-bank-table"]',
        'interact-tables-exams-itembank-row-hover.png',
        LOOSE_OPTS
      );
    });
    ...
    test('item bank empty search result', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-tables-exams-itembank-empty-search.png',
        STABLE_OPTS
      );
    });
    ...
    test('item bank pagination last page', async ({ page }) => {
      ...
      const lastBtn = page
        .locator(
          '[data-testid="last-page"], button:has-text("Last"), [aria-label*="last"]'
        )
        .first();
      ...
      await screenshotElement(
        ...
        'interact-tables-exams-itembank-page-last.png'
      );
    });
  });
  ...
  test.describe('Analytics tables', () => {
    test('analytics data table default', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        'table, [data-testid="analytics-table"], [role="grid"]',
        'interact-tables-analytics-default.png',
        LOOSE_OPTS
      );
    });
    ...
    test('analytics table sort by metric', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-tables-analytics-sorted.png',
        LOOSE_OPTS
      );
    });
    ...
    test('analytics table filter applied', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-tables-analytics-filter-applied.png',
  ...
  test.describe('Table loading/empty states', () => {
    test('loading skeleton state', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-tables-admin-users-loading.png',
        LOOSE_OPTS
      );
    });
    ...
    test('empty table no data', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-tables-admin-users-empty.png',
        STABLE_OPTS
      );
    });
    ...
    test('error state in table', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-tables-admin-users-error.png',
        STABLE_OPTS
      );
    });
    ...
    test('table with bulk action bar', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="bulk-actions"], [data-testid="action-bar"]',
        'interact-tables-admin-users-bulk-actions.png'
      );
    });
    ...
    test('table column resize handle visible', async ({ page }) => {
      ...
      const resizeHandle = page
        .locator('[data-testid="resize-handle"], .resize-handle, th .resizer')
        .first();
      ...
      await screenshotElement(
        page,
        'table thead, [role="grid"] [role="row"]:first-child',
        'interact-tables-admin-users-resize-handle.png'
      );
    });
  });
});
