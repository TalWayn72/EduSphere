...
test.describe('Full Page — Desktop 1280x720', () => {
  ...
  test('search desktop', async ({ page }) => { await prep(page, '/search', 1280, 720);
    await expect(page).toHaveScreenshot('exh-search-d-full.png', STABLE_OPTS); });
  test('knowledge-graph desktop', async ({ page }) => { await prep(page, '/knowledge-graph', 1280, 720);
    await expect(page).toHaveScreenshot('exh-kg-d-full.png', STABLE_OPTS); });
  test('profile desktop', async ({ page }) => { await prep(page, '/profile', 1280, 720);
    await expect(page).toHaveScreenshot('exh-profile-d-full.png', STABLE_OPTS); });
  test('settings desktop', async ({ page }) => { await prep(page, '/settings', 1280, 720);
    await expect(page).toHaveScreenshot('exh-settings-d-full.png', STABLE_OPTS); });
  test('notifications desktop', async ({ page }) => { await prep(page, '/notifications', 1280, 720);
    await expect(page).toHaveScreenshot('exh-notif-d-full.png', STABLE_OPTS); });
  test('calendar desktop', async ({ page }) => { await prep(page, '/calendar', 1280, 720);
    await expect(page).toHaveScreenshot('exh-calendar-d-full.png', STABLE_OPTS); });
  test('grades desktop', async ({ page }) => { await prep(page, '/grades', 1280, 720);
    await expect(page).toHaveScreenshot('exh-grades-d-full.png', STABLE_OPTS); });
  test('certificates desktop', async ({ page }) => { await prep(page, '/certificates', 1280, 720);
...
test.describe('Full Page — Tablet 768x1024', () => {
  ...
  test('search tablet', async ({ page }) => { await prep(page, '/search', 768, 1024);
    await expect(page).toHaveScreenshot('exh-search-t-full.png', STABLE_OPTS); });
  test('knowledge-graph tablet', async ({ page }) => { await prep(page, '/knowledge-graph', 768, 1024);
    await expect(page).toHaveScreenshot('exh-kg-t-full.png', STABLE_OPTS); });
  test('profile tablet', async ({ page }) => { await prep(page, '/profile', 768, 1024);
    await expect(page).toHaveScreenshot('exh-profile-t-full.png', STABLE_OPTS); });
  test('settings tablet', async ({ page }) => { await prep(page, '/settings', 768, 1024);
    await expect(page).toHaveScreenshot('exh-settings-t-full.png', STABLE_OPTS); });
  test('notifications tablet', async ({ page }) => { await prep(page, '/notifications', 768, 1024);
    await expect(page).toHaveScreenshot('exh-notif-t-full.png', STABLE_OPTS); });
  test('calendar tablet', async ({ page }) => { await prep(page, '/calendar', 768, 1024);
    await expect(page).toHaveScreenshot('exh-calendar-t-full.png', STABLE_OPTS); });
  test('grades tablet', async ({ page }) => { await prep(page, '/grades', 768, 1024);
    await expect(page).toHaveScreenshot('exh-grades-t-full.png', STABLE_OPTS); });
  test('certificates tablet', async ({ page }) => { await prep(page, '/certificates', 768, 1024);
...
test.describe('Full Page — Mobile 375x812', () => {
  ...
  test('search mobile', async ({ page }) => { await prep(page, '/search', 375, 812);
    await expect(page).toHaveScreenshot('exh-search-m-full.png', STABLE_OPTS); });
  test('knowledge-graph mobile', async ({ page }) => { await prep(page, '/knowledge-graph', 375, 812);
    await expect(page).toHaveScreenshot('exh-kg-m-full.png', STABLE_OPTS); });
  test('profile mobile', async ({ page }) => { await prep(page, '/profile', 375, 812);
    await expect(page).toHaveScreenshot('exh-profile-m-full.png', STABLE_OPTS); });
  test('settings mobile', async ({ page }) => { await prep(page, '/settings', 375, 812);
    await expect(page).toHaveScreenshot('exh-settings-m-full.png', STABLE_OPTS); });
  test('notifications mobile', async ({ page }) => { await prep(page, '/notifications', 375, 812);
    await expect(page).toHaveScreenshot('exh-notif-m-full.png', STABLE_OPTS); });
  test('calendar mobile', async ({ page }) => { await prep(page, '/calendar', 375, 812);
    await expect(page).toHaveScreenshot('exh-calendar-m-full.png', STABLE_OPTS); });
  test('grades mobile', async ({ page }) => { await prep(page, '/grades', 375, 812);
    await expect(page).toHaveScreenshot('exh-grades-m-full.png', STABLE_OPTS); });
  test('certificates mobile', async ({ page }) => { await prep(page, '/certificates', 375, 812);
...
test.describe('Sidebar — Desktop', () => {
  ...
  test('courses sidebar', async ({ page }) => { await prep(page, '/courses', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('search sidebar', async ({ page }) => { await prep(page, '/search', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('kg sidebar', async ({ page }) => { await prep(page, '/knowledge-graph', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
      await expect(el).toHaveScreenshot('exh-kg-d-sidebar.png', EO);
    else await expect(page).toHaveScreenshot('exh-kg-d-sidebar.png', EO); });
  test('profile sidebar', async ({ page }) => { await prep(page, '/profile', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('settings sidebar', async ({ page }) => { await prep(page, '/settings', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('notifications sidebar', async ({ page }) => { await prep(page, '/notifications', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('calendar sidebar', async ({ page }) => { await prep(page, '/calendar', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('grades sidebar', async ({ page }) => { await prep(page, '/grades', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('certificates sidebar', async ({ page }) => { await prep(page, '/certificates', 1280, 720); const el = page.locator(S).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
...
test.describe('Header — Desktop', () => {
  ...
  test('courses header', async ({ page }) => { await prep(page, '/courses', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('search header', async ({ page }) => { await prep(page, '/search', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('kg header', async ({ page }) => { await prep(page, '/knowledge-graph', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
      await expect(el).toHaveScreenshot('exh-kg-d-header.png', EO);
    else await expect(page).toHaveScreenshot('exh-kg-d-header.png', EO); });
  test('profile header', async ({ page }) => { await prep(page, '/profile', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('settings header', async ({ page }) => { await prep(page, '/settings', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('notifications header', async ({ page }) => { await prep(page, '/notifications', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('calendar header', async ({ page }) => { await prep(page, '/calendar', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('grades header', async ({ page }) => { await prep(page, '/grades', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('certificates header', async ({ page }) => { await prep(page, '/certificates', 1280, 720); const el = page.locator(H).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
...
test.describe('Main Content — Tablet', () => {
  ...
  test('courses main', async ({ page }) => { await prep(page, '/courses', 768, 1024); const el = page.locator(M).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('search main', async ({ page }) => { await prep(page, '/search', 768, 1024); const el = page.locator(M).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('kg main', async ({ page }) => { await prep(page, '/knowledge-graph', 768, 1024); const el = page.locator(M).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
      await expect(el).toHaveScreenshot('exh-kg-t-main.png', EO);
    else await expect(page).toHaveScreenshot('exh-kg-t-main.png', EO); });
  test('profile main', async ({ page }) => { await prep(page, '/profile', 768, 1024); const el = page.locator(M).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
...
test.describe('Cards — Mobile', () => {
  ...
  test('courses cards', async ({ page }) => { await prep(page, '/courses', 375, 812); const el = page.locator(C).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('search cards', async ({ page }) => { await prep(page, '/search', 375, 812); const el = page.locator(C).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('grades cards', async ({ page }) => { await prep(page, '/grades', 375, 812); const el = page.locator(C).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('certificates cards', async ({ page }) => { await prep(page, '/certificates', 375, 812); const el = page.locator(C).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
...
test.describe('Action Buttons — Desktop', () => {
  ...
  test('courses actions', async ({ page }) => { await prep(page, '/courses', 1280, 720); const el = page.locator(A).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('settings actions', async ({ page }) => { await prep(page, '/settings', 1280, 720); const el = page.locator(A).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('notifications actions', async ({ page }) => { await prep(page, '/notifications', 1280, 720); const el = page.locator(A).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
  ...
  test('calendar actions', async ({ page }) => { await prep(page, '/calendar', 1280, 720); const el = page.locator(A).first();
    if (await el.isVisible({ timeout: 3000 }).catch(() => false))
