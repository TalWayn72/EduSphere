...
test.describe('Visual Interactions — Modals & Dialogs', () => {
  ...
  test.describe('Modal backdrop', () => {
    test('modal with backdrop overlay', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-courses-backdrop-overlay.png',
        STABLE_OPTS
      );
    });
    ...
    test('nested modal over existing dialog', async ({ page }) => {
      ...
      const settingsBtn = page
        .locator('[data-testid="course-settings"], button:has-text("Settings")')
        .first();
      if (await settingsBtn.isVisible({ timeout: 3000 }).catch(() => false)) {
        ...
        const dangerBtn = page
          .locator(
            '[data-testid="danger-zone"], button:has-text("Delete"), [role="dialog"] button:has-text("Delete")'
          )
          .first();
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-course-nested-dialog.png',
        STABLE_OPTS
      );
    });
    ...
    test('full screen modal', async ({ page }) => {
      ...
      const fullscreenBtn = page
        .locator(
          '[data-testid="fullscreen-btn"], button:has-text("Fullscreen"), [aria-label*="fullscreen"]'
        )
        .first();
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-course-fullscreen.png',
        STABLE_OPTS
      );
    });
    ...
    test('modal scrollable content', async ({ page }) => {
      ...
      const addUserBtn = page
        .locator(
          '[data-testid="add-user"], button:has-text("Add User"), button:has-text("Invite")'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="dialog"], [data-testid="user-modal"]',
        'interact-modals-admin-add-user-modal.png'
      );
    });
  });
  ...
  test.describe('Command palette', () => {
    test('command palette open (Ctrl+K)', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-modals-dashboard-command-palette.png'
      );
    });
    ...
    test('command palette with search text', async ({ page }) => {
      ...
      const input = page
        .locator(
          '[cmdk-input], [data-testid="command-input"], [role="dialog"] input'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[data-testid="command-palette"], [role="dialog"], [cmdk-root]',
        'interact-modals-dashboard-command-search.png'
      );
    });
  });
  ...
  test.describe('Modal tablet viewport', () => {
    test('delete dialog at tablet', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-tablet-delete-dialog.png',
        STABLE_OPTS
      );
    });
    ...
    test('filter drawer at tablet', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-tablet-filter-drawer.png',
        STABLE_OPTS
      );
    });
    ...
    test('command palette at tablet', async ({ page }) => {
      ...
      await page.waitForTimeout(400);
      await expect(page).toHaveScreenshot(
        'interact-modals-tablet-command-palette.png',
        STABLE_OPTS
      );
    });
    ...
    test('toast at tablet', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-tablet-toast.png',
        STABLE_OPTS
      );
    });
  });
  ...
  test.describe('Modal wide desktop', () => {
    test('delete dialog at wide desktop', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-wide-delete-dialog.png',
        STABLE_OPTS
      );
    });
    ...
    test('settings drawer at wide desktop', async ({ page }) => {
      ...
      const advancedBtn = page
        .locator(
          '[data-testid="advanced-settings"], button:has-text("Advanced")'
        )
        .first();
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-wide-settings-drawer.png',
        STABLE_OPTS
      );
    });
    ...
    test('command palette at wide desktop', async ({ page }) => {
      ...
      await page.waitForTimeout(400);
      await expect(page).toHaveScreenshot(
        'interact-modals-wide-command-palette.png',
        STABLE_OPTS
      );
    });
  });
  ...
  test.describe('Modal keyboard interaction', () => {
    test('dialog close via Escape key', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-after-escape.png',
        STABLE_OPTS
      );
    });
    ...
    test('dialog focus trap — Tab cycling', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-modals-focus-trap.png',
        STABLE_OPTS
      );
    });
  });
