...
const FORM_PAGES = [
  {
    ...
    name: 'course-create',
    formSelector:
      'form, [data-testid="course-form"], [data-testid="create-course-form"]',
    buttonSelector:
      'button[type="submit"], [data-testid="submit-btn"], [data-testid="form-actions"]',
  },
  {
    path: '/content-import',
    name: 'content-import',
    formSelector:
      'form, [data-testid="import-form"], [data-testid="content-import-form"]',
    buttonSelector:
      'button[type="submit"], [data-testid="import-btn"], [data-testid="form-actions"]',
  },
  {
    path: '/admin/settings',
    name: 'admin-settings-form',
    formSelector:
      'form, [data-testid="admin-settings-form"], [data-testid="settings-form"]',
    buttonSelector:
      'button[type="submit"], [data-testid="save-btn"], [data-testid="form-actions"]',
  },
  {
    path: '/settings',
    name: 'user-settings-form',
    formSelector:
      'form, [data-testid="user-settings-form"], [data-testid="settings-form"]',
    buttonSelector:
      'button[type="submit"], [data-testid="save-btn"], [data-testid="form-actions"]',
  },
  {
    ...
    name: 'profile-form',
    formSelector:
      'form, [data-testid="profile-form"], [data-testid="profile-edit-form"]',
    buttonSelector:
      'button[type="submit"], [data-testid="save-btn"], [data-testid="form-actions"]',
  },
] as const;
  ...
  for (const vp of VIEWPORTS) {
    test.describe(`${vp.name} — form input states`, () => {
      test(`form input focus at ${vp.name}`, async ({ page }) => {
        ...
        await page.waitForTimeout(500);
        const input = page
          .locator('input[name="title"], input[name="name"], input')
          .first();
