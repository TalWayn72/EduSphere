/**
 * Visual Regression — Error States
 *
 * Tests error boundary, GraphQL error, empty state, and network error
 * rendering across all major pages. Uses page.route() to intercept
 * GraphQL requests and simulate failure conditions.
 *
 * ~20 screenshot assertions covering:
 * - 404 page (nonexistent route)
 * - GraphQL errors on 7 authenticated pages
 * - Empty states (no data) on 5 pages
 * - Network error simulation on 4 pages
 * - 500 server error responses on 3 pages
 */
...
test.describe('Visual Regression — Error States', () => {
  ...
  /* ---------------------------------------------------------------- */
  /*  Network Timeout / Connection Refused (2 pages)                   */
  /* ---------------------------------------------------------------- */
  ...
  /* ---------------------------------------------------------------- */
  /*  500 Server Error Responses (3 pages)                             */
  /* ---------------------------------------------------------------- */
