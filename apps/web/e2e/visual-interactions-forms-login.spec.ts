...
test.describe('Visual Interactions — Forms (Login)', () => {
  ...
  test('login form default state', async ({ page }) => {
    ...
    await screenshotElement(
      page,
      'form, [data-testid="login-form"], main',
      'interact-forms-login-default.png'
    );
  });
  ...
  test('login email input focused', async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    const email = page
      .locator('input[type="email"], input[name="email"], #username')
      .first();
    ...
    await screenshotElement(
      page,
      'form, [data-testid="login-form"], main',
      'interact-forms-login-email-focused.png'
    );
  });
  ...
  test('login password input focused', async ({ page }) => {
    ...
    await screenshotElement(
      page,
      'form, [data-testid="login-form"], main',
      'interact-forms-login-password-focused.png'
    );
  });
  ...
  test('login form with filled values', async ({ page }) => {
    ...
    await screenshotElement(
      page,
      'form, [data-testid="login-form"], main',
      'interact-forms-login-filled.png'
    );
  });
  ...
  test('login button hover state', async ({ page }) => {
    ...
    const btn = page
      .locator(
        '[data-testid="dev-login-btn"], button[type="submit"], button:has-text("Sign")'
      )
      .first();
    ...
    await screenshotElement(
      page,
      'form, [data-testid="login-form"], main',
      'interact-forms-login-btn-hover.png'
    );
  });
});
