        ...
        body: JSON.stringify({
          data: {
            course: {
              ...
              modules: [
                { id: 'm1', title: 'Module 1', lessons: [LESSON_WITH_PDF] },
              ],
            },
          },
        }),
...
test.describe('Visual Regression — PDF Viewer @visual-pdf', () => {
  ...
  test('pdf viewer — tablet toolbar', async ({ page }) => {
    ...
    const toolbar = page
      .locator(
        '[role="toolbar"], [data-testid="pdf-toolbar"], .pdf-toolbar, header'
      )
      .first();
    await screenshotElOrPage(toolbar, page, 'pdf-viewer-tablet-toolbar.png', {
      ...LOOSE_OPTS,
      fullPage: false,
    });
  });
  ...
  test('pdf viewer — tablet document area', async ({ page }) => {
    ...
    await goTo(page, '/learn/courses/c1/lessons/lesson-pdf-1');
    const docArea = page
      .locator('[data-testid="pdf-document"], canvas, .pdf-container, main')
      .first();
    await screenshotElOrPage(docArea, page, 'pdf-viewer-tablet-document.png', {
      ...LOOSE_OPTS,
      fullPage: false,
    });
  });
  ...
  test('pdf viewer — mobile toolbar', async ({ page }) => {
    ...
    const toolbar = page
      ...
      .first();
    await screenshotElOrPage(toolbar, page, 'pdf-viewer-mobile-toolbar.png', {
      ...LOOSE_OPTS,
      fullPage: false,
    });
  });
  ...
  test('pdf viewer — mobile document area', async ({ page }) => {
    ...
    const docArea = page
      .locator('[data-testid="pdf-document"], canvas, .pdf-container, main')
      .first();
    await screenshotElOrPage(docArea, page, 'pdf-viewer-mobile-document.png', {
      ...LOOSE_OPTS,
      fullPage: false,
    });
  });
  ...
  test('pdf viewer — wide desktop toolbar', async ({ page }) => {
    ...
    const toolbar = page
      ...
      .first();
    await screenshotElOrPage(toolbar, page, 'pdf-viewer-wide-toolbar.png', {
      ...LOOSE_OPTS,
      fullPage: false,
    });
  });
  ...
  test('pdf viewer — wide desktop document', async ({ page }) => {
    ...
    const docArea = page
      .locator('[data-testid="pdf-document"], canvas, .pdf-container, main')
      .first();
    await screenshotElOrPage(docArea, page, 'pdf-viewer-wide-document.png', {
      ...LOOSE_OPTS,
      fullPage: false,
    });
  });
  ...
  test('pdf viewer — fit to width', async ({ page }) => {
    ...
    const fitWidth = page
      .locator(
        '[data-testid="fit-width"], [aria-label="Fit to width"], button:has-text("Fit")'
      )
      .first();
  ...
  test('pdf viewer — page input navigation', async ({ page }) => {
    ...
    const pageInput = page
      .locator(
        '[data-testid="page-input"], input[type="number"], [aria-label*="page number"]'
      )
      .first();
  ...
  test('pdf viewer — print preview trigger', async ({ page }) => {
    ...
    const printBtn = page
      .locator(
        '[data-testid="pdf-print"], button[aria-label*="print"], button:has-text("Print")'
      )
      .first();
  ...
  test('pdf viewer — download button hover', async ({ page }) => {
    ...
    const downloadBtn = page
      .locator(
        '[data-testid="pdf-download"], button[aria-label*="download"], button:has-text("Download")'
      )
      .first();
  ...
  test('pdf viewer — search panel', async ({ page }) => {
    ...
    const searchBtn = page
      .locator(
        '[data-testid="pdf-search"], button[aria-label*="search"], button:has-text("Search")'
      )
      .first();
  ...
  test('pdf viewer — annotation create mode', async ({ page }) => {
    ...
    const annotBtn = page
      .locator(
        '[data-testid="annotate-btn"], button[aria-label*="annotate"], button:has-text("Annotate")'
      )
      .first();
  ...
  test('pdf viewer — course page at tablet', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot(
      'pdf-viewer-course-content-tablet.png',
      LOOSE_OPTS
    );
  });
  ...
  test('pdf viewer — course page at mobile', async ({ page }) => {
    ...
    await goTo(page, '/learn/courses/c1');
    await expect(page).toHaveScreenshot(
      'pdf-viewer-course-content-mobile.png',
      LOOSE_OPTS
    );
  });
  ...
  test('pdf viewer — learn page at tablet', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot(
      'pdf-viewer-learn-sources-tablet.png',
      LOOSE_OPTS
    );
  });
  ...
  test('pdf viewer — learn page at mobile', async ({ page }) => {
    ...
    await goTo(page, '/learn');
    await expect(page).toHaveScreenshot(
      'pdf-viewer-learn-sources-mobile.png',
      LOOSE_OPTS
    );
  });
});
