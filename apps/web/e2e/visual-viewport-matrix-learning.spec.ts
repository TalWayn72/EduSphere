...
const LEARNING_PAGES = [
  ...
  },
  {
    ...
    name: 'assessments',
    section:
      '[data-testid="assessments-list"], [data-testid="assessment-content"], main',
  },
  {
    path: '/social',
    name: 'social',
    section:
      '[data-testid="social-feed"], [data-testid="social-content"], main',
  },
  {
    path: '/knowledge-graph',
    name: 'knowledge-graph',
    section:
      '[data-testid="graph-canvas"], [data-testid="knowledge-graph"], canvas, main',
  },
  {
    path: '/analytics',
    name: 'analytics',
    section:
      '[data-testid="analytics-charts"], [data-testid="analytics-content"], main',
  },
] as const;
  ...
  for (const vp of VIEWPORTS) {
    test.describe(`${vp.name} — footer & sidebar`, () => {
      ...
      test(`learning sidebar at ${vp.name}`, async ({ page }) => {
        ...
        await page.waitForTimeout(500);
        const sidebar = page
          .locator('aside, [data-testid="app-sidebar"], [role="complementary"]')
          .first();
