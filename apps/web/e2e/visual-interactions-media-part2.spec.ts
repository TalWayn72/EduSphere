...
test.describe('Visual Interactions — Media Responsive & Sections', () => {
  ...
  test.describe('Media tablet viewport', () => {
    ...
    test('knowledge graph at tablet', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-media-graph-tablet.png'
      );
    });
    test('code editor at tablet', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-media-code-editor-tablet.png'
      );
    });
    test('rich text editor at tablet', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-media-richtext-tablet.png'
      );
    });
    test('analytics chart at tablet', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-media-chart-tablet.png'
      );
    });
    test('video player at tablet', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-media-video-tablet.png'
      );
    });
  });
  ...
  test.describe('Media mobile viewport', () => {
    ...
    test('knowledge graph at mobile', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="knowledge-graph"], canvas, .graph-container',
        'interact-media-graph-mobile.png'
      );
    });
    test('analytics chart at mobile', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="chart"], canvas, .recharts-wrapper',
        'interact-media-chart-mobile.png'
      );
    });
    test('rich text editor at mobile', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="rich-editor"], .tiptap, .ProseMirror',
        'interact-media-richtext-mobile.png'
      );
    });
    test('video player at mobile', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="video-player"], video, .video-container',
        'interact-media-video-mobile.png'
      );
    });
  });
  ...
  test.describe('Media wide desktop', () => {
    test('analytics full page at wide desktop', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-media-analytics-wide-full.png',
        LOOSE_OPTS
      );
    });
    test('knowledge graph at wide desktop', async ({ page }) => {
      ...
      await page.waitForTimeout(800);
      await expect(page).toHaveScreenshot(
        'interact-media-graph-wide-full.png',
        LOOSE_OPTS
      );
    });
    test('course content at wide desktop', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-media-course-wide-full.png',
        LOOSE_OPTS
      );
    });
    test('course create at wide desktop', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-media-course-create-wide.png',
        LOOSE_OPTS
      );
    });
  });
  ...
  test.describe('Media page sections', () => {
    test('analytics header section', async ({ page }) => {
      ...
      await page.waitForTimeout(800);
      const header = page
        .locator('header, nav, [data-testid="analytics-header"]')
        .first();
      if (await header.isVisible({ timeout: 3000 }).catch(() => false)) {
        await expect(header).toHaveScreenshot(
          'interact-media-analytics-header.png',
          LOOSE_OPTS
        );
      }
    });
    test('course detail sidebar', async ({ page }) => {
      ...
      const sidebar = page
        .locator(
          'aside, [data-testid="course-sidebar"], [role="complementary"]'
        )
        .first();
      if (await sidebar.isVisible({ timeout: 3000 }).catch(() => false)) {
        await expect(sidebar).toHaveScreenshot(
          'interact-media-course-sidebar.png',
          LOOSE_OPTS
        );
      }
    });
    test('course create form area', async ({ page }) => {
      ...
      if (await form.isVisible({ timeout: 3000 }).catch(() => false)) {
        await expect(form).toHaveScreenshot(
          'interact-media-course-create-form.png',
          LOOSE_OPTS
        );
      }
    });
