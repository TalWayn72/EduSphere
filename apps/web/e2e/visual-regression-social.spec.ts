...
test.describe('Visual Regression — Social Feed @visual-social', () => {
  ...
  test('social feed — post cards', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="feed-list"]', '[role="feed"]', 'main'],
      'social-feed-posts.png',
  ...
  test('social feed — sidebar widgets', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['aside', '[data-testid="social-sidebar"]', 'nav'],
      'social-feed-sidebar.png'
    );
  });
  ...
  test('social feed — compose area', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="compose-post"]', 'textarea', '[role="textbox"]'],
      'social-feed-compose.png'
    );
  });
});
...
test.describe('Visual Regression — Challenges @visual-social', () => {
  ...
  test('challenges — challenge cards', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="challenge-list"]', '.grid', '[role="list"]'],
      'social-challenges-cards.png'
    );
  });
  ...
  test('challenges — leaderboard', async ({ page }) => {
    ...
    await elementOrPage(
      ...
      'social-challenges-leaderboard.png'
    );
  });
});
...
test.describe('Visual Regression — Discussions @visual-social', () => {
  ...
  test('discussions — thread list', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="thread-list"]', '[role="list"]', 'main'],
      'social-discussions-threads.png'
    );
  });
  ...
  test('discussions — category filters', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="category-filters"]', '[role="tablist"]', 'nav'],
      'social-discussions-categories.png'
    );
  });
});
...
test.describe('Visual Regression — Peer Matching @visual-social', () => {
  ...
  test('peer matching — header section', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['header', '[data-testid="page-header"]', 'h1'],
      'social-peermatching-header.png'
    );
  });
  ...
  test('peer matching — match cards', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="match-list"]', '.grid', '[role="list"]', 'main'],
      'social-peermatching-cards.png'
    );
  });
});
...
test.describe('Visual Regression — Profile @visual-social', () => {
  ...
  test('profile — header with avatar', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['header', '[data-testid="profile-header"]', 'h1'],
      'social-profile-header.png'
    );
  });
  ...
  test('profile — bio section', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="profile-bio"]', '.bio', 'section'],
      'social-profile-bio.png'
    );
  });
  ...
  test('profile — activity feed', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="activity-feed"]', '[role="list"]', 'main'],
      'social-profile-activity.png'
    );
  });
  ...
  test('profile — badges section', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="badges"]', '.badges', 'section'],
      'social-profile-badges.png'
    );
  });
  ...
  test('discussions — search bar', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="search-bar"]', '[role="search"]', 'input[type="search"]'],
      'social-discussions-search.png'
    );
  });
  ...
  test('challenges — progress tracker', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="progress-tracker"]', '.progress', '[role="progressbar"]'],
      'social-challenges-progress.png'
    );
  });
  ...
  test('peer matching — compatibility score', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="compatibility-score"]', '.score', 'section'],
      'social-peermatching-score.png'
    );
  });
  ...
  test('social feed — action buttons', async ({ page }) => {
    ...
    await elementOrPage(
      page,
      ['[data-testid="feed-actions"]', '.actions', 'button'],
      'social-feed-actions.png'
    );
  });
});
