...
test.describe('Chart Visual — Analytics Dashboard @visual-charts', () => {
  ...
  test('analytics dashboard — enrollment chart area', async ({ page }) => {
    ...
    await expect(chart).toHaveScreenshot('chart-analytics-dashboard-enrollment.png', CHART_OPTS);
  });

  test('analytics dashboard — KPI summary cards', async ({ page }) => {
    await setupMockAndGo(page, '/analytics', MOCK_ANALYTICS_DATA);
    const kpi = page.locator('[data-testid="kpi-cards"], .stats-row, .grid').first();
    await expect(kpi).toHaveScreenshot('chart-analytics-dashboard-kpi.png', CHART_OPTS);
  });
  ...
  test('analytics dashboard — completion rate indicator', async ({ page }) => {
    ...
    await expect(rate).toHaveScreenshot('chart-analytics-dashboard-completion.png', CHART_OPTS);
  });
  ...
  test('analytics dashboard — score distribution', async ({ page }) => {
    ...
    await expect(scores).toHaveScreenshot('chart-analytics-dashboard-scores.png', CHART_OPTS);
  });
});
...
test.describe('Chart Visual — Course Analytics @visual-charts', () => {
  ...
  test('course analytics — enrollment trend line', async ({ page }) => {
    ...
    await expect(chart).toHaveScreenshot('chart-analytics-course-enrollment.png', CHART_OPTS);
  });
  ...
  test('course analytics — completion funnel', async ({ page }) => {
    ...
    await expect(funnel).toHaveScreenshot('chart-analytics-course-funnel.png', CHART_OPTS);
  });
  ...
  test('course analytics — average score bar chart', async ({ page }) => {
    ...
    await expect(bar).toHaveScreenshot('chart-analytics-course-scores.png', CHART_OPTS);
  });
  ...
  test('course analytics — active students metric', async ({ page }) => {
    ...
    await expect(metric).toHaveScreenshot('chart-analytics-course-active.png', CHART_OPTS);
  });
});
...
test.describe('Chart Visual — Tenant Analytics @visual-charts', () => {
  ...
  test('tenant analytics — usage over time chart', async ({ page }) => {
    ...
    await expect(chart).toHaveScreenshot('chart-analytics-tenant-usage.png', CHART_OPTS);
  });
  ...
  test('tenant analytics — tenant comparison bars', async ({ page }) => {
    ...
    await expect(bars).toHaveScreenshot('chart-analytics-tenant-comparison.png', CHART_OPTS);
  });
  ...
  test('tenant analytics — active rate gauges', async ({ page }) => {
    ...
    await expect(gauges).toHaveScreenshot('chart-analytics-tenant-rates.png', CHART_OPTS);
  });
});
...
test.describe('Chart Visual — ROI Analytics @visual-charts', () => {
  ...
  test('ROI analytics — monthly ROI trend', async ({ page }) => {
    ...
    await expect(chart).toHaveScreenshot('chart-analytics-roi-trend.png', CHART_OPTS);
  });
  ...
  test('ROI analytics — cost breakdown pie', async ({ page }) => {
    ...
    await expect(pie).toHaveScreenshot('chart-analytics-roi-breakdown.png', CHART_OPTS);
  });
  ...
  test('ROI analytics — investment vs return comparison', async ({ page }) => {
    ...
    await expect(comparison).toHaveScreenshot('chart-analytics-roi-comparison.png', CHART_OPTS);
  });
});
...
test.describe('Chart Visual — Platform Usage @visual-charts', () => {
  ...
  test('platform usage — active users multi-line chart', async ({ page }) => {
    ...
    await expect(chart).toHaveScreenshot('chart-analytics-platform-users.png', CHART_OPTS);
  });
  ...
  test('platform usage — system health gauges', async ({ page }) => {
    ...
    await expect(health).toHaveScreenshot('chart-analytics-platform-health.png', CHART_OPTS);
  });
  ...
  test('platform usage — feature adoption horizontal bars', async ({ page }) => {
    ...
    await expect(bars).toHaveScreenshot('chart-analytics-platform-adoption.png', CHART_OPTS);
  });
  ...
  test('platform usage — storage usage indicator', async ({ page }) => {
    ...
    await expect(storage).toHaveScreenshot('chart-analytics-platform-storage.png', CHART_OPTS);
  });
  ...
  test('platform usage — error rate trend', async ({ page }) => {
    ...
    await expect(errorRate).toHaveScreenshot('chart-analytics-platform-errorrate.png', CHART_OPTS);
  });
  ...
  test('platform usage — response time histogram', async ({ page }) => {
    ...
    await expect(histogram).toHaveScreenshot('chart-analytics-platform-responsetime.png', CHART_OPTS);
  });
});
