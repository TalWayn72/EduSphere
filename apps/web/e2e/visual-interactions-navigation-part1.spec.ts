...
test.describe('Visual Interactions — Navigation (Part 1)', () => {
  ...
  test.describe('Sidebar', () => {
    test('collapsed sidebar state', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="app-sidebar"], nav, aside',
        'interact-nav-dashboard-sidebar-collapsed.png'
      );
    });
    ...
    test('expanded sidebar state', async ({ page }) => {
      ...
      const toggle = page
        .locator(
          '[data-testid="sidebar-toggle"], [aria-label*="sidebar"], [aria-label*="menu"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[data-testid="app-sidebar"], nav, aside',
        'interact-nav-dashboard-sidebar-expanded.png'
      );
    });
    ...
    test('sidebar hover on nav item', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      const navItem = page
        .locator('nav a, aside a, [data-testid="nav-item"]')
        .first();
      ...
      await screenshotElement(
        page,
        'nav, aside, [data-testid="app-sidebar"]',
        'interact-nav-dashboard-sidebar-hover.png'
      );
    });
    ...
    test('sidebar active item highlight', async ({ page }) => {
      ...
      await expect(page).toHaveScreenshot(
        'interact-nav-dashboard-sidebar-active.png',
        STABLE_OPTS
      );
    });
  });
  ...
  test.describe('Mobile hamburger menu', () => {
    test('hamburger menu closed (mobile)', async ({ page }) => {
      ...
      await page.waitForTimeout(500);
      await expect(page).toHaveScreenshot(
        'interact-nav-mobile-hamburger-closed.png',
        STABLE_OPTS
      );
    });
    ...
    test('hamburger menu open (mobile)', async ({ page }) => {
      ...
      const hamburger = page
        .locator(
          '[data-testid="hamburger-menu"], [aria-label*="menu"], button:has(svg)'
        )
        .first();
      ...
      await expect(page).toHaveScreenshot(
        'interact-nav-mobile-hamburger-open.png',
        STABLE_OPTS
      );
    });
    ...
    test('mobile nav overlay visible', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="mobile-nav"], [role="dialog"], [data-state="open"]',
        'interact-nav-mobile-overlay.png'
      );
    });
  });
  ...
  test.describe('Breadcrumbs', () => {
    test('breadcrumb on courses page', async ({ page }) => {
      ...
      await screenshotElement(
        ...
        'interact-nav-courses-breadcrumb.png'
      );
    });
    ...
    test('breadcrumb on nested page', async ({ page }) => {
      ...
      await screenshotElement(
        page,
        '[data-testid="breadcrumb"], nav[aria-label*="breadcrumb"], .breadcrumb',
        'interact-nav-course-detail-breadcrumb.png'
      );
    });
    ...
    test('breadcrumb hover state', async ({ page }) => {
      ...
      const crumb = page
        .locator(
          '[data-testid="breadcrumb"] a, nav[aria-label*="breadcrumb"] a'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[data-testid="breadcrumb"], nav[aria-label*="breadcrumb"], .breadcrumb',
        'interact-nav-courses-breadcrumb-hover.png'
      );
    });
  });
  ...
  test.describe('Dashboard tabs', () => {
    ...
    for (const tab of tabs) {
      test(`dashboard tab: ${tab}`, async ({ page }) => {
        ...
        const tabEl = page
          .locator(
            `[data-testid="tab-${tab}"], [role="tab"]:has-text("${tab}"), button:has-text("${tab}")`
          )
          .first();
        ...
        await expect(page).toHaveScreenshot(
          `interact-nav-dashboard-tab-${tab}.png`,
  ...
  test.describe('Dropdown menus', () => {
    test('action dropdown on dashboard', async ({ page }) => {
      ...
      const trigger = page
        .locator(
          '[data-testid="actions-dropdown"], [aria-haspopup="menu"], [data-testid="dropdown-trigger"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="menu"], [data-state="open"], [data-testid="dropdown-content"]',
        'interact-nav-dashboard-dropdown-open.png'
      );
    });
    ...
    test('sort dropdown on courses', async ({ page }) => {
      ...
      const sortBtn = page
        .locator(
          '[data-testid="sort-dropdown"], button:has-text("Sort"), [aria-label*="sort"]'
        )
        .first();
      ...
      await screenshotElement(
        ...
        'interact-nav-courses-sort-dropdown.png'
      );
    });
    ...
    test('filter dropdown on courses', async ({ page }) => {
      ...
      const filterBtn = page
        .locator(
          '[data-testid="filter-dropdown"], button:has-text("Filter"), [aria-label*="filter"]'
        )
        .first();
      ...
      await screenshotElement(
        page,
        '[role="menu"], [data-state="open"], [data-testid="filter-panel"]',
        'interact-nav-courses-filter-dropdown.png'
      );
    });
  });
});
