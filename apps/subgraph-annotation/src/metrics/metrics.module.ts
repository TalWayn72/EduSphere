...
registry.setDefaultLabels({ service: 'subgraph-annotation' });
collectDefaultMetrics({ register: registry, prefix: 'edusphere_' });

export const HTTP_REQUEST_DURATION = new Histogram({
  name: 'edusphere_annotation_http_request_duration_seconds',
...
export const HTTP_REQUESTS_TOTAL = new Counter({
  name: 'edusphere_annotation_http_requests_total',
...
export const GRAPHQL_QUERY_DURATION = new Histogram({
  name: 'edusphere_annotation_graphql_query_duration_seconds',
