  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>{t('conflicts.title', { count: conflicts.length })}</Text>
      ...
      <ScrollView style={styles.list} nestedScrollEnabled>
        {conflicts.map((c) => (
          <View key={c.id} style={styles.item}>
            ...
            <TouchableOpacity onPress={() => dismiss(c.id)} style={styles.dismissBtn}>
...
const styles = StyleSheet.create({
  container: { backgroundColor: '#FEF3C7', borderRadius: 8, margin: 12, padding: 12, borderWidth: 1, borderColor: '#F59E0B' },
  ...
  list: { maxHeight: 120 },
  item: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 4, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#FDE68A' },
