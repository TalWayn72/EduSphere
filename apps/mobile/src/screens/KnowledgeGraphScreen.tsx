    ...
    <View style={styles.container}>
      ...
      >
        {(['CONCEPT', 'PERSON', 'SOURCE', 'TERM'] as const).map((type) => (
          ...
          >
            <Text style={[styles.filterChipText, { color: TYPE_COLORS[type] }]}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <View style={styles.nodeInfo}>
              ...
              <Text
                style={[styles.nodeType, { color: TYPE_COLORS[item.type] }]}
              >
                {item.type}
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            <Text style={styles.emptyText}>{t('noConcepts')}</Text>
          </View>
        }
      />
      <Modal
            ...
            {selectedNode && (
              <>
                ...
                {selectedNode.connections !== undefined && (
                  <Text style={styles.modalConnections}>
                    🔗 {selectedNode.connections} {t('relationships')}
                  </Text>
                )}
              </>
            )}
