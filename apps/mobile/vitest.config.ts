...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'src/screens/__tests__/CoursesScreen.test.tsx',
      'src/screens/__tests__/AITutorScreen.test.tsx',
      ...
      'src/screens/__tests__/BrandedSplashScreen.test.ts',
      'src/screens/__tests__/VideoMigration.test.ts',
      'src/hooks/useWhiteLabel.test.ts',
