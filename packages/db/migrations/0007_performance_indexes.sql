...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_annotations_tenant_asset_layer
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_annotations_tenant_user_personal
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_courses_user_status
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_transcript_segments_transcript_time
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_lessons_course_status
  ON lessons(course_id, status) WHERE deleted_at IS NULL;

-- Lessons: tenant + status (tenant-wide lesson status queries)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_lessons_tenant_status
