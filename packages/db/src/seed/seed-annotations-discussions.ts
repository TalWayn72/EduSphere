...
export async function seedAnnotationsDiscussions(): Promise<void> {
    ...
    .values([
      {
        ...
        layer:           'PERSONAL',
        content:         { text: 'Connection between tzimtzum and kavvanot — important!' },
        text_start:      120,
        text_end:        180,
      ...
      },
      {
        ...
        layer:           'SHARED',
        content:         { text: 'Key topic for next class discussion: the comparison method' },
      },
    ])
    .onConflictDoNothing();
    ...
    .values([
      {
        ...
        description:     'Discussion on 4 approaches to Tzimtzum — literal or metaphorical?',
      ...
      },
      {
        ...
        description:     'Are the Rashash kavvanot still halachically relevant today?',
  ...
  await db
    ...
    .values([
      // Discussion 1 — Chavruta on Tzimtzum
      {
        ...
        user_id:       STUDENT_ID,
        content:       'I think the tzimtzum is metaphorical — the infinite light did not literally move.',
        message_type:  'TEXT',
      },
      {
        id:                MSG_IDS.d1m2,
        discussion_id:     DISCUSSION_IDS.d1,
        user_id:           KAB_INSTRUCTOR,
        content:           'But Ramchal disagrees! He writes tzimtzum is about revelation, not essence.',
        message_type:      'TEXT',
      ...
      },
      {
        ...
        discussion_id:     DISCUSSION_IDS.d1,
        user_id:           STUDENT_ID,
        content:           'I found a source in Nahar Shalom (question 52) that supports the metaphorical approach.',
        message_type:      'TEXT',
      ...
      // Discussion 2 — Forum on modern kavvanot
      {
        ...
        user_id:       KAB_INSTRUCTOR,
        content:       'Rav Kadouri ztl used the Rashash kavvanot until his last day — proof of relevance.',
        message_type:  'TEXT',
      },
      {
        id:            MSG_IDS.d2m2,
        discussion_id: DISCUSSION_IDS.d2,
        user_id:       STUDENT_ID,
        content:       'Is there a practical abbreviated version of the kavvanot for busy people?',
        message_type:  'TEXT',
      },
    ])
    .onConflictDoNothing();
  ...
  await db
    ...
    .values([
      { id: PART_IDS.d1student,    discussion_id: DISCUSSION_IDS.d1, user_id: STUDENT_ID },
      { id: PART_IDS.d1instructor, discussion_id: DISCUSSION_IDS.d1, user_id: KAB_INSTRUCTOR },
      { id: PART_IDS.d2student,    discussion_id: DISCUSSION_IDS.d2, user_id: STUDENT_ID },
      { id: PART_IDS.d2kab,        discussion_id: DISCUSSION_IDS.d2, user_id: KAB_INSTRUCTOR },
    ])
    .onConflictDoNothing();
