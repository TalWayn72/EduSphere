...
const IDS = {
  ...
  seg: (n: number) => `fa100000-0000-0000-0000-${String(n).padStart(12, '0')}`,
  blk: (n: number) => `fa200000-0000-0000-0000-${String(n).padStart(12, '0')}`,
} as const;
...
// ─── Standalone run ───────────────────────────────────────────────────────────
if (process.argv[1] && process.argv[1].includes('seed-kabbalah-etz-chaim')) {
