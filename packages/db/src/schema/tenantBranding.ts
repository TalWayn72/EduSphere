...
export const tenantBranding = pgTable('tenant_branding', {
  ...
  logoUrl: varchar('logo_url', { length: 512 }).notNull().default('/defaults/logo.svg'),
  logoMarkUrl: varchar('logo_mark_url', { length: 512 }),
  faviconUrl: varchar('favicon_url', { length: 512 }).notNull().default('/defaults/favicon.ico'),
  ...
  hideEduSphereBranding: boolean('hide_edusphere_branding').notNull().default(false),
