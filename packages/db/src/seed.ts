...
async function seed() {
  ...
  try {
    ...
    await db.insert(users).values([
      {
        ...
        tenant_id: defaultTenant?.id || '00000000-0000-0000-0000-000000000000',
    ...
    const [course1] = await db.insert(courses).values({
      ...
      description: 'Explore fundamental concepts in Jewish philosophical thought',
    ...
    console.log('   - 5 users (1 super admin, 1 org admin, 1 instructor, 2 students)');
