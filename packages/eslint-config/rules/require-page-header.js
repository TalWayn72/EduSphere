...
const EXEMPT_FRAGMENTS = [
  'Step', 'Card', 'Modal', 'Dialog', 'Banner', 'Section',
  'Panel', 'Filter', 'Filters', 'Grid', 'Form', 'Field', 'Fields',
  'Canvas', 'Control', 'Controls', 'Sidebar', 'Icon', 'Highlight',
  'Helper', 'Helpers', 'Selector', 'Renderer', 'Toolbar', 'Badge',
  'Overlay', 'Widget', 'Item', 'Result', 'Anchor', 'Anchors',
  'Source', 'Stepper', 'Indicator', 'Preview', 'Slides',
  'Button', 'Nav', 'List', 'Modules', 'Player', 'Report',
  'Simulator', 'Zone', 'Layer', 'Timeline', 'Comment',
  'Stats', 'Table', 'Revenue', 'Config', 'Run', 'Node',
  'Editor', 'Block', 'View', 'Bar', 'Display', 'Irt',
  'data', 'utils', 'EmptyState', 'OfflineBanner',
  'Browse', 'Catalog', 'Management', 'Blueprint', 'Distributions',
  'Settings', 'Invoice',
];
