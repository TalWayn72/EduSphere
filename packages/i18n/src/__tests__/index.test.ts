...
describe('packages/i18n exports', () => {
  ...
  it('exports exactly 28 namespaces', () => {
    expect(NAMESPACES).toHaveLength(28);
  });

  it('all locale directories exist with all 28 namespace files', () => {
...
describe('NAMESPACES', () => {
  it('contains exactly 28 namespaces', () => {
    expect(NAMESPACES).toHaveLength(28);
  });
